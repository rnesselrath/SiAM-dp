...
public class LayoutExecutableContentNodeFeature  extends AbstractLayoutShapeFeature{
	...
	public LayoutExecutableContentNodeFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return businessObjects.size() == 1 && businessObjects.get(0) instanceof ExecutableContentNode;
	}
