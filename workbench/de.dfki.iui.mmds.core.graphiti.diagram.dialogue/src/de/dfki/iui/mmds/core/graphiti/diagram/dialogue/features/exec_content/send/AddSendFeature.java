...
/**
 * Adding {@link Send} feature
 * This class implements a pictogram element that has to be added. 
 * This pictogram element has to link to a {@link Send} object.
 * 
 * @author Dragan Milchevski
 * Created on: Jun 16, 2013
 *
 */
public class AddSendFeature extends AbstractAddFeature implements IAddFeature{

	/**
	 * Creates new {@link AddSendFeature}
	 * @param fp the feature provider
	 */
	public AddSendFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		final Send addedSend = (Send) context.getNewObject();
		...
		Rectangle rectangle;
		{
			...
			link(containerShape, addedSend);
		}
		{ //SHAPE WITH IMAGE
			Shape shape = peCreateService.createShape(containerShape, false);
			Image image = gaService.createImage(shape, DialogueImageProvider.IMG_SEND);
		...
		// SHAPE WITH TEXT
		{
			...
			Text text = gaService.createPlainText(shape, "Send");
