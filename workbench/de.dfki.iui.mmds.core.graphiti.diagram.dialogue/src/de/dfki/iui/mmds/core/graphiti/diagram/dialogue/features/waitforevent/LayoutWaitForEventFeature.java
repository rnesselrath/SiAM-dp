...
public class LayoutWaitForEventFeature  extends AbstractLayoutShapeFeature{
	...
	public LayoutWaitForEventFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return businessObjects.size() == 1 && businessObjects.get(0) instanceof WaitForEvent;
	}
