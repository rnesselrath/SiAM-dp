 ...
 *
 *******************************************************************************/
package de.dfki.iui.mmds.core.graphiti.diagram.dialogue.navigator;
...
import de.dfki.iui.mmds.core.graphiti.diagram.dialogue.navigator.nodes.EClassesNode;
import de.dfki.iui.mmds.core.graphiti.diagram.dialogue.navigator.nodes.base.IContainerNode;
...
public class GFEmfLabelProvider extends LabelProvider {
	...
	public Image getImage(Object element) {
		...
		if (element instanceof EClass) {
			String imageKey = DialogueImageProvider.IMG_DIALOGUE;
			return PlatformUI.getWorkbench().getSharedImages().getImage(imageKey);
		}
	...
	private Image getEClassesNodeImage() {
		...
		Image image = registry.get(key);
		if (image == null) {
			ImageDescriptor desc = ExamplesCommonPlugin.imageDescriptorFromPlugin("de.dfki.iui.mmds.core.graphiti.diagram.dialogue", key); //$NON-NLS-1$
			registry.put(key, desc);
			image = registry.get(key);
		}
		return image;
