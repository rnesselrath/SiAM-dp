...
/**
 * The class UpdateFeature. Used to update a pictogram element when some changes are done, e.g. editing text. 
 * 
...
public class UpdateFeature extends AbstractUpdateFeature{
	...
	/**
	 * Creates new {@link UpdateFeature}
	 * @param fp
	 */
	...
	public boolean canUpdate(IUpdateContext context) {
		Object bo = getBusinessObjectForPictogramElement(context
				.getPictogramElement());
		return (bo instanceof DialogueDesignerElement);
	}
