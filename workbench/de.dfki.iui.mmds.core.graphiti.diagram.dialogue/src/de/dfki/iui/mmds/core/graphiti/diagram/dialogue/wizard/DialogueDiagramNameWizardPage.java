...
public class DialogueDiagramNameWizardPage extends AbstractWizardPage {
	...
	public DialogueDiagramNameWizardPage(String pageName, String title, ImageDescriptor titleImage) {
		super(pageName, title, titleImage);
	}


	protected DialogueDiagramNameWizardPage(String pageName) {
		super(pageName);
		setTitle(PAGE_TITLE);
