...
/**
 * The class {@link DeleteStateFeature} for deleting objects of type {@link State}
 * @author Dragan
 *
 */
public class DeleteStateFeature extends AbstractFeature implements IDeleteFeature {
	 ...
	 */
	public DeleteStateFeature(IFeatureProvider fp) {
		super(fp);
	}
