...
/**
 * Adding {@link If} feature
 * This class implements a pictogram element that has to be added. 
 * This pictogram element has to link to a {@link If} object.
 * 
 * @author Dragan Milchevski
 *
 */
public class AddExecIfFeature extends AbstractAddFeature implements IAddFeature{

	/**
	 * Creates new {@link AddExecIfFeature}
	 * @param fp the feature provider
	 */
	public AddExecIfFeature(IFeatureProvider fp) {
		super(fp);
	}
	
	/**
	 * Check the container if it is of a type entry or exit or ExecutableContentNode 
	 * 
	...
	public PictogramElement add(IAddContext context) {
		final If addedIf = (If) context.getNewObject();
		...
		Rectangle rectangle;
		{
			...
			link(containerShape, addedIf);
		}
		{ //SHAPE WITH IMAGE
			Shape shape = peCreateService.createShape(containerShape, false);
			Image image = gaService.createImage(shape, DialogueImageProvider.IMG_IF_EXEC);
		...
		// SHAPE WITH TEXT
		{
			...
			Text text = gaService.createPlainText(shape, "If");
