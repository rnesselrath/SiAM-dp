...
public class LayoutDecisionFeauture extends AbstractLayoutShapeFeature{
	...
	public LayoutDecisionFeauture(IFeatureProvider fp) {
		super(fp);
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return businessObjects.size() == 1 && businessObjects.get(0) instanceof Decision;
	}
