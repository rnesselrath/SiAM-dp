...
/**
 * Adding {@link While} feature
 * This class implements a pictogram element that has to be added. 
 * This pictogram element has to link to a {@link While} object.
 * 
 * @author Dragan Milchevski
 *
 */
public class AddWhileFeature extends AbstractAddFeature implements IAddFeature{
	...
	/**
	 * Creates new {@link AddWhileFeature}
	 * @param fp the feature provider
	 */
	public AddWhileFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
		...
		if(context.getNewObject() instanceof While){
	...
	public PictogramElement add(IAddContext context) {
		final While addedWhile = (While)context.getNewObject();
...
//
//				Object[] bos = {addedWhile, (Dialogue)bo};
//				link(getDiagram(), bos);
...
//			System.out.println("X="+X+" Y="+Y+" WIDTH="+WIDTH+" HEIGHT="+HEIGHT);
			Rectangle rectangle; // need to access it later
			{
				...
				link(containerShape, addedWhile);
			}
			...
			// SHAPE WITH TEXT NAME
			{
				...
				// create and set text graphics algorithm
				final Text text = gaService.createPlainText(shape, addedWhile.getDisplayName());
				text.setStyle(StyleUtil.getStyleForStateChartText(getDiagram()));
			...
			{
				final Shape shape = peCreateService.createShape(containerShape, false);
				final Image image = gaService.createImage(shape, DialogueImageProvider.IMG_WHILE);
