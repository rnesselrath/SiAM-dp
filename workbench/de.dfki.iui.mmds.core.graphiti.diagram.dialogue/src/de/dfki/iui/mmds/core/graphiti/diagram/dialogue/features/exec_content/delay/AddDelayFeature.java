...
/**
 * Adding {@link Delay} feature
 * This class implements a pictogram element that has to be added. 
 * This pictogram element has to link to a {@link Delay} object.
 * 
 * @author Dragan Milchevski
 * Created on: Jun 17, 2013
 *
 */
public class AddDelayFeature extends AbstractAddFeature implements IAddFeature {

	/**
	 * Creates new {@link AddDelayFeature}
	...
	public PictogramElement add(IAddContext context) {
		...
		{ //SHAPE WITH IMAGE
			...
			Image image = gaService.createImage(shape, DialogueImageProvider.IMG_DELAY);
		...
		// SHAPE WITH TEXT
		{
			...
			Text text = gaService.createPlainText(shape, "Delay");
