...
public class ApplicationWizardMessages extends NLS {

	private static final String BUNDLE_NAME = "de.dfki.iui.mmds.sdk.wizards.application.application_wizard";
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, ApplicationWizardMessages.class);
	}
