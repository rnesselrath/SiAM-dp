...
final class TransitionTargetComparator<T> implements Comparator<T>, Serializable {
	 ...
	 * Important Remarks:
	 * </p>
	 * does not fullfill the Comparator contract, since it returns 0 if o1 == o2
	 * and also if they are not related to each other and at the same time the
	 * chain-to-parent length for o1 is the same length as for o2 (that is, they
	 * are equally deeply nested)
	 *
	 * @param o1
	 *            The first TransitionTarget object
	 * @param o2
	 *            The second TransitionTarget object
