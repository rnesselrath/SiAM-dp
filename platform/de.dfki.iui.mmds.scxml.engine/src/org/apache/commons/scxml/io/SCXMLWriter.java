...
/**
 * <p>
 * Utility class for serializing the Commons SCXML Java object model. Class uses
 * the visitor pattern to trace through the object heirarchy. Used primarily for
 * testing, debugging and visual verification.
 * </p>
 * 
 * <b>NOTE:</b> This writer makes the following assumptions about the original
 * SCXML document(s) parsed to create the object model:
 * <ul>
 * <li>The default document namespace is the SCXML namespace:
 * <i>http://www.w3.org/2005/07/scxml</i></li>
 * <li>The Commons SCXML namespace ( <i>http://commons.apache.org/scxml</i> ),
 * if needed, uses the &quot;<i>cs</i>&quot; prefix</li>
 * <li>All namespace prefixes needed throughout the document are declared on the
 * document root element (&lt;scxml&gt;)</li>
 * </ul>
 * 
 * @since 1.0
 */
public class SCXMLWriter {
	 ...
	 * primarily for testing, debugging and visual verification), returned as a
	 * string.
	 * 
	 * @param scxml
	 *            The object model to serialize.
	 * 
	 * @return The corresponding SCXML document as a string.
	 * 
	 * @throws IOException
	 *             An IO error during serialization.
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	public static String write(final SCXML scxml) throws IOException, XMLStreamException {
	 ...
	 *            The object model to serialize.
	 * @param configuration
	 *            The {@link Configuration} to use while serializing.
	 * 
	 * @return The corresponding SCXML document as a string.
	 * 
	 * @throws IOException
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	public static String write(final SCXML scxml, final Configuration configuration) throws IOException, XMLStreamException {
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	public static void write(final SCXML scxml, final OutputStream scxmlStream) throws IOException, XMLStreamException {
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	public static void write(final SCXML scxml, final OutputStream scxmlStream, final Configuration configuration) throws IOException, XMLStreamException {
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	public static void write(final SCXML scxml, final Writer scxmlWriter) throws IOException, XMLStreamException {
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	public static void write(final SCXML scxml, final Writer scxmlWriter, final Configuration configuration) throws IOException, XMLStreamException {
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	public static void write(final SCXML scxml, final Result scxmlResult) throws IOException, XMLStreamException {
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	public static void write(final SCXML scxml, final Result scxmlResult, final Configuration configuration) throws IOException, XMLStreamException {
	...
	/**
	 * Write out the Commons SCXML object model using the supplied
	 * {@link Configuration}. Exactly one of the stream, writer or result
	 ...
	 *            The {@link Configuration} to use.
	 * @param scxmlStream
	 *            The optional {@link OutputStream} to write to.
	 * @param scxmlWriter
	 *            The optional {@link Writer} to write to.
	 * @param scxmlResult
	 *            The optional {@link Result} to write to.
	 * 
	 * @throws IOException
	 *             An IO error during serialization.
	 * @throws XMLStreamException
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeInternal(final SCXML scxml, final Configuration configuration, final OutputStream scxmlStream, final Writer scxmlWriter, final Result scxmlResult) throws IOException,
			XMLStreamException {
	...
	/**
	 * Write out the Commons SCXML object model as an SCXML document using the
	 * supplied {@link Configuration}. This method tackles the XML document
	 * level concerns.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param configuration
	 *            The {@link Configuration} in use.
	 * @param scxml
	 *            The root of the object model to write out.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeDocument(final XMLStreamWriter writer, final Configuration configuration, final SCXML scxml) throws XMLStreamException {
	...
	/**
	 * Write out this {@link SCXML} object into its serialization as the
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeSCXML(final XMLStreamWriter writer, final SCXML scxml) throws XMLStreamException {
		...
		for (Map.Entry<String, String> entry : scxml.getNamespaces().entrySet()) {
			...
			if (key != null && key.trim().length() > 0 && !key.equals("cs"))
		...
		writeAV(writer, ATTR_ID, scxml.getId()); // @CUSTOM: for SCXML use
													// ATTR_ID instead
	...
	/**
	 * Write out this {@link Datamodel} object into its serialization as the
	 * corresponding &lt;datamodel&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param datamodel
	 *            The {@link Datamodel} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeDatamodel(final XMLStreamWriter writer, final Datamodel datamodel) throws XMLStreamException {
	...
	/**
	 * Write out this {@link State} object into its serialization as the
	 * corresponding &lt;state&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param state
	 *            The {@link State} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeState(final XMLStreamWriter writer, final State state) throws XMLStreamException {
	...
	/**
	 * Write out this {@link Parallel} object into its serialization as the
	 * corresponding &lt;parallel&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param parallel
	 *            The {@link Parallel} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeParallel(final XMLStreamWriter writer, final Parallel parallel) throws XMLStreamException {
	...
	/**
	 * Write out this {@link Final} object into its serialization as the
	 * corresponding &lt;final&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param end
	 *            The {@link Final} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeFinal(final XMLStreamWriter writer, final Final end) throws XMLStreamException {
	...
	/**
	 * Write out this {@link Initial} object into its serialization as the
	 * corresponding &lt;initial&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param initial
	 *            The {@link Initial} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeInitial(final XMLStreamWriter writer, final Initial initial) throws XMLStreamException {
	...
	/**
	 * Write out this {@link History} list into its serialization as the
	 * corresponding set of &lt;history&gt; elements.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param history
	 *            The {@link History} list to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeHistory(final XMLStreamWriter writer, final List<History> history) throws XMLStreamException {
	...
	/**
	 * Write out this {@link OnEntry} object into its serialization as the
	 * corresponding &lt;onentry&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param onentry
	 *            The {@link OnEntry} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeOnEntry(final XMLStreamWriter writer, final OnEntry onentry) throws XMLStreamException {
	...
	/**
	 * Write out this {@link OnExit} object into its serialization as the
	 * corresponding &lt;onexit&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param onexit
	 *            The {@link OnExit} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeOnExit(final XMLStreamWriter writer, final OnExit onexit) throws XMLStreamException {
	...
	/**
	 * Write out this {@link Transition} object into its serialization as the
	 * corresponding &lt;transition&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param transition
	 *            The {@link Transition} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeTransition(final XMLStreamWriter writer, final Transition transition) throws XMLStreamException {
	...
	/**
	 * Write out this {@link Invoke} object into its serialization as the
	 * corresponding &lt;invoke&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param invoke
	 *            The {@link Invoke} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeInvoke(final XMLStreamWriter writer, final Invoke invoke) throws XMLStreamException {
	...
	/**
	 * Write out this {@link Finalize} object into its serialization as the
	 * corresponding &lt;finalize&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param finalize
	 *            The {@link Finalize} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeFinalize(final XMLStreamWriter writer, final Finalize finalize) throws XMLStreamException {
	...
	/**
	 * Write out this executable content (list of actions) into its
	 * serialization as the corresponding set of action elements. Custom actions
	 * aren't serialized.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param actions
	 *            The list of actions to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeExecutableContent(final XMLStreamWriter writer, final List<Action> actions) throws XMLStreamException {
	...
	/**
	 * Write out this {@link Send} object into its serialization as the
	 * corresponding &lt;send&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param send
	 *            The {@link Send} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeSend(final XMLStreamWriter writer, final Send send) throws XMLStreamException {

		writer.writeStartElement(XMLNS_SCXML, ELEM_SEND);
		writeAV(writer, ATTR_SENDID, send.getId());
	...
	/**
	 * Write out this {@link If} object into its serialization as the
	 * corresponding &lt;if&gt; element.
	 * 
	 * @param writer
	 *            The {@link XMLStreamWriter} in use for the serialization.
	 * @param iff
	 *            The {@link If} to serialize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeIf(final XMLStreamWriter writer, final If iff) throws XMLStreamException {
	 ...
	 *            The model element containing the external body content.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeExternalContent(final XMLStreamWriter writer, final ExternalContent externalContent) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeNode(final XMLStreamWriter writer, final Node node) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	private static void writeAV(final XMLStreamWriter writer, final String localName, final String value) throws XMLStreamException {
		if (value != null)
			writer.writeAttribute(localName, value);
	}

	/**
	 * Write the serialized SCXML document while making attempts to make the
	 * serialization human readable. This includes using new-lines and
	 * indentation as appropriate, where possible. Exactly one of the stream,
	 * writer or result parameters must be provided.
	 * 
	 * @param configuration
	 *            The {@link Configuration} to use.
	 * @param scxmlStream
	 ...
	 *             {@link XMLStreamWriter}.
	 */
	private static void writePretty(final Configuration configuration, final OutputStream scxmlStream, final Writer scxmlWriter, final Result scxmlResult) throws IOException, XMLStreamException {

		// There isn't any portable way to write pretty using the JDK 1.6 StAX
		// API
		configuration.internalWriter.flush();
	 ...
	 * {@link XMLStreamWriter} for this {@link SCXMLWriter}. Exactly one of the
	 * stream, writer or result parameters must be provided.
	 * 
	 * @param configuration
	 *            The {@link Configuration} to use.
	 * @param stream
	 ...
	 * 
	 * @throws XMLStreamException
	 *             A problem with the XML stream creation.
	 */
	private static XMLStreamWriter getWriter(final Configuration configuration, final OutputStream stream, final Writer writer, final Result result) throws XMLStreamException {
		...
		if (configuration.factoryId != null && configuration.factoryClassLoader != null) {
			...
			// factory = XMLOutputFactory.newInstance(configuration.factoryId,
	 ...
	 * 
	 * <ul>
	 * <li>{@link XMLOutputFactory} configuration properties such as
	 * <code>factoryId</code> or any properties</li>
	 * <li>{@link XMLStreamWriter} configuration properties such as target
	 * {@link Writer} or {@link OutputStream} and the <code>encoding</code></li>
	 * </ul>
	 */
	public static class Configuration {
		...
		/**
		 * The {@link ClassLoader} to use for the {@link XMLOutputFactory}
		 * instance to create.
		 */
		 ...
		 * object property values) for the {@link XMLOutputFactory}.
		 */
		...
		/**
		 * Whether to use a pretty print style that makes the output much more
		 * human readable.
		 */
		final boolean usePrettyPrint;

		/**
		 * The intermediate writer that will hold the output to be pretty
		 * printed, given the lack of a standard StAX property for the
		 * {@link XMLOutputFactory} in this regard. The contents will get
		 * transformed using the transformation API.
		 */
		...
		/**
		 * Whether to maintain an internal writer to return the serialization as
		 * a string.
		 */
		 ...
		 * <code>null</code> (booleans should default to <code>false</code>). At
		 * the moment, the <code>factoryId</code> and
		 * <code>factoryClassLoader</code> arguments are effectively ignored due
		 * to a bug in the underlying StAX {@link XMLOutputFactory} API.
		 * 
		 * @param factoryId
		 *            The <code>factoryId</code> to use.
		 * @param factoryClassLoader
		 *            The {@link ClassLoader} to use for the
		 *            {@link XMLOutputFactory} instance to create.
		 * @param properties
		 ...
		 *            Whether to make the output human readable as far as
		 *            possible. Since StAX does not provide a portable way to do
		 *            this in JDK 1.6, choosing the pretty print option is
		 *            currently not very efficient.
		 * @param closeUnderlyingWhenDone
		 *            Whether to close the underlying stream or writer passed by
		 *            the caller.
		 */
		public Configuration(final String factoryId, final ClassLoader factoryClassLoader, final Map<String, Object> properties, final String encoding, final boolean usePrettyPrint,
				final boolean closeUnderlyingWhenDone) {
		 ...
		 * 
		 * @param writeToString
		 *            Whether we will be returning the serialization as a
		 *            string.
		 * @param usePrettyPrint
		 *            Whether we will attempt to make the output human readable
		 *            as far as possible.
		 */
		 ...
		 *            the caller.
		 * @param writeToString
		 *            Whether to maintain an internal writer to return the
		 *            serialization as a string.
		 */
		Configuration(final String factoryId, final ClassLoader factoryClassLoader, final Map<String, Object> properties, final String encoding, final boolean usePrettyPrint,
