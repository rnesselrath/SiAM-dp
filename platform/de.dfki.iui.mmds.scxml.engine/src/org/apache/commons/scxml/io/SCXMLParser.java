...
public final class SCXMLParser {
	 ...
	 * @see PathResolver
	 */
	public static SCXML parse(final URL scxmlURL, final ErrorHandler errHandler) throws IOException, SAXException, ModelException {
	 ...
	 * @see PathResolver
	 */
	public static SCXML parse(final String documentRealPath, final ErrorHandler errHandler, final PathResolver pathResolver)
	 ...
	 * @see ErrorHandler
	 */
	public static SCXML parse(final InputSource documentInputSource, final ErrorHandler errHandler) throws IOException,
	 ...
	 * @see PathResolver
	 */
	public static SCXML parse(final URL scxmlURL, final ErrorHandler errHandler, final List<CustomAction> customActions)
			throws IOException, SAXException, ModelException {
	 ...
	 * @see SCXMLParser#updateSCXML(SCXML)
	 */
	public static Digester newInstance(final SCXML scxml, final PathResolver pr, final List<CustomAction> customActions) {
	 ...
	 */
	private static ExtendedBaseRules initRules(final SCXML scxml, final PathResolver pr, final List<CustomAction> customActions) {
	 ...
	 *            The list of custom actions this digester needs to be able to process
	 */
	private static void addTransitionRules(final String xp, final ExtendedBaseRules scxmlRules, final String setNextMethod,
			final PathResolver pr, final List<CustomAction> customActions) {
		scxmlRules.add(xp, new ObjectCreateRule(Transition.class));
		scxmlRules.add(xp, new SetPropertiesRule(new String[] { "event", "cond", "target" }, new String[] { "event", "cond",
				"next" }));
		scxmlRules.add(xp, new SetCurrentNamespacesRule());
	 ...
	 */
	private static void addSimpleRulesTuple(final String xp, final ExtendedBaseRules scxmlRules, final Class<?> klass,
			final String[] args, final String[] props, final String addMethod) {
	...
	private static class ParseDataRule extends NodeCreateRule {
		 ...
		 */
		@Override
		public final void begin(final String namespace, final String name, final Attributes attributes) throws Exception {
	...
	private static class DigestSrcAttributeRule extends Rule {
		 ...
		 */
		@Override
		public final void begin(final String namespace, final String name, final Attributes attributes) throws ModelException {
	...
	private static class IgnoredElementRule extends Rule {
		...
		public final void begin(final String namespace, final String name, final Attributes attributes) {
			...
			sb.append("Ignoring element <").append(name).append("> in namespace \"").append(namespace).append("\" at ")
					.append(identifier).append(":").append(l.getLineNumber()).append(":").append(l.getColumnNumber())
					.append(" and digester match \"").append(getDigester().getMatch()).append("\"");
