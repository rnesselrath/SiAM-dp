...
/**
 * <p>
 * The SCXMLReader provides the ability to read a SCXML document into the Java
 * object model provided in the model package.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * <b>NOTE:</b> The SCXMLReader assumes that the SCXML document to be parsed is
 * well-formed and correct. If that assumption does not hold, any subsequent
...
public final class SCXMLReader {
	...
	// ---- NAMESPACES ----//
	/**
	 * The SCXML namespace that this Reader is built for. Any document that is
	 * intended to be parsed by this reader <b>must</b> bind the SCXML elements
	 * to this namespace.
	 */
	 ...
	 */
	private static final String ERR_CUSTOM_ACTION_TYPE = "Custom actions list" + " contained unknown object, class not a Commons SCXML Action class subtype: ";

	/**
	 * Parser configuration error while trying to parse stream to DOM node(s).
	 */
	private static final String ERR_PARSER_CFG = "ParserConfigurationException while trying" + " to parse stream into DOM node(s).";
	 ...
	 * 
	 * @param scxmlPath
	 *            The real path to the SCXML document.
	 * 
	 * @return The parsed output, the Commons SCXML object model corresponding
	 *         to the SCXML document.
	 * 
	 * @throws IOException
	 *             An IO error during parsing.
	 * @throws ModelException
	 *             The Commons SCXML object model is incomplete or inconsistent
	 *             (includes errors in the SCXML document that may not be
	 *             identified by the schema).
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 ...
	 *            The real path to the SCXML document.
	 * @param configuration
	 *            The {@link Configuration} to use when parsing the SCXML
	 *            document.
	 * 
	 * @return The parsed output, the Commons SCXML object model corresponding
	 *         to the SCXML document.
	 ...
	 *             {@link XMLStreamReader}.
	 */
	public static SCXML read(final String scxmlPath, final Configuration configuration) throws IOException, ModelException, XMLStreamException {
	 ...
	 * 
	 * @param scxmlURL
	 *            The SCXML document {@link URL} to parse.
	 * 
	 * @return The parsed output, the Commons SCXML object model corresponding
	 *         to the SCXML document.
	 * 
	...
	/**
	 * Parse the SCXML document at the supplied {@link URL} with the given
	 * {@link Configuration}.
	 * 
	 * @param scxmlURL
	 *            The SCXML document {@link URL} to parse.
	 ...
	 *             {@link XMLStreamReader}.
	 */
	public static SCXML read(final URL scxmlURL, final Configuration configuration) throws IOException, ModelException, XMLStreamException {
	 ...
	 * 
	 * @param scxmlStream
	 *            The {@link InputStream} supplying the SCXML document to parse.
	 * 
	 * @return The parsed output, the Commons SCXML object model corresponding
	 *         to the SCXML document.
	 * 
	...
	/**
	 * Parse the SCXML document supplied by the given {@link InputStream} with
	 ...
	 *             {@link XMLStreamReader}.
	 */
	public static SCXML read(final InputStream scxmlStream, final Configuration configuration) throws IOException, ModelException, XMLStreamException {
	 ...
	 * 
	 * @param scxmlReader
	 *            The {@link Reader} supplying the SCXML document to parse.
	 * 
	 * @return The parsed output, the Commons SCXML object model corresponding
	 *         to the SCXML document.
	 * 
	...
	/**
	 * Parse the SCXML document supplied by the given {@link Reader} with the
	 ...
	 *             {@link XMLStreamReader}.
	 */
	public static SCXML read(final Reader scxmlReader, final Configuration configuration) throws IOException, ModelException, XMLStreamException {
	 ...
	 * 
	 * @param scxmlSource
	 *            The {@link Source} supplying the SCXML document to parse.
	 * 
	 * @return The parsed output, the Commons SCXML object model corresponding
	 *         to the SCXML document.
	 * 
	...
	/**
	 * Parse the SCXML document supplied by the given {@link Source} with the
	 * given {@link Configuration}.
	 * 
	 * @param scxmlSource
	 *            The {@link Source} supplying the SCXML document to parse.
	 ...
	 *             {@link XMLStreamReader}.
	 */
	public static SCXML read(final Source scxmlSource, final Configuration configuration) throws IOException, ModelException, XMLStreamException {
	 ...
	 * {@link Configuration}, but do not wire up the object model to be usable
	 * just yet. Exactly one of the url, path, stream, reader or source
	 ...
	 *            document.
	 * @param scxmlURL
	 *            The optional SCXML document {@link URL} to parse.
	 * @param scxmlPath
	 *            The optional real path to the SCXML document as a string.
	 * @param scxmlStream
	 *            The optional {@link InputStream} providing the SCXML document.
	 * @param scxmlReader
	 *            The optional {@link Reader} providing the SCXML document.
	 * @param scxmlSource
	 *            The optional {@link Source} providing the SCXML document.
	 * 
	 * @return The parsed output, the Commons SCXML object model corresponding
	 *         to the SCXML document (not wired up to be immediately usable).
	 * 
	 * @throws IOException
	 *             An IO error during parsing.
	 * @throws ModelException
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static SCXML readInternal(final Configuration configuration, final URL scxmlURL, final String scxmlPath, final InputStream scxmlStream, final Reader scxmlReader, final Source scxmlSource)
	 ...
	 * 
	 * @param reader
	 *            The {@link XMLStreamReader} providing the SCXML document to
	 *            parse.
	 * @param configuration
	 *            The {@link Configuration} to use while parsing.
	 * 
	 * @return The parsed output, the Commons SCXML object model corresponding
	 *         to the SCXML document (not wired up to be immediately usable).
	 * 
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static SCXML readDocument(final XMLStreamReader reader, final Configuration configuration) throws IOException, ModelException, XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param scxml
	 *            The root of the object model being parsed.
	 * 
	 * @throws IOException
	 *             An IO error during parsing.
	 * @throws ModelException
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readSCXML(final XMLStreamReader reader, final Configuration configuration, final SCXML scxml) throws IOException, ModelException, XMLStreamException {

		scxml.setExmode(readAV(reader, ATTR_EXMODE));
		scxml.setInitial(readAV(reader, ATTR_INITIAL));
		scxml.setId(readAV(reader, ATTR_ID)); // @CUSTOM: for SCXML use ATTR_ID
												// instead
	 ...
	 *            The root of the object model being parsed.
	 * @param parent
	 *            The parent {@link TransitionTarget} for this state (null for
	 *            top level state).
	 * 
	 * @throws IOException
	 *             An IO error during parsing.
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readState(final XMLStreamReader reader, final Configuration configuration, final SCXML scxml, final TransitionTarget parent) throws IOException, ModelException,
			XMLStreamException {
	 ...
	 *            The root of the object model being parsed.
	 * @param parent
	 *            The parent {@link TransitionTarget} for this parallel (null
	 *            for top level state).
	 * 
	 * @throws IOException
	 *             An IO error during parsing.
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readParallel(final XMLStreamReader reader, final Configuration configuration, final SCXML scxml, final TransitionTarget parent) throws IOException, ModelException,
			XMLStreamException {
	 ...
	 *            The root of the object model being parsed.
	 * @param parent
	 *            The parent {@link TransitionTarget} for this final (null for
	 *            top level state).
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readFinal(final XMLStreamReader reader, final Configuration configuration, final SCXML scxml, final TransitionTarget parent) throws XMLStreamException {
	...
	/**
	 * Parse the contents of the SCXML document that this "src" attribute value
	 * of a &lt;state&gt; or &lt;parallel&gt; element points to. Without a URL
	 * fragment, the entire state machine is imported as contents of the
	 * &lt;state&gt; or &lt;parallel&gt;. If a URL fragment is present, the
	 * fragment must specify the id of the corresponding &lt;state&gt; or
	 * &lt;parallel&gt; to import.
	 * 
	 * @param configuration
	 *            The {@link Configuration} to use while parsing.
	 ...
	 * @param tt
	 *            The parent {@link TransitionTarget} that specifies this "src"
	 *            attribute.
	 * 
	 * @throws IOException
	 *             An IO error during parsing.
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readTransitionTargetSrc(final Configuration configuration, final String src, final TransitionTarget tt) throws IOException, ModelException, XMLStreamException {
	 ...
	 *            The root of the object model being parsed.
	 * @param parent
	 *            The parent {@link TransitionTarget} for this datamodel (null
	 *            for top level).
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readDatamodel(final XMLStreamReader reader, final Configuration configuration, final SCXML scxml, final TransitionTarget parent) throws XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param dm
	 *            The parent {@link Datamodel} for this data.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readData(final XMLStreamReader reader, final Configuration configuration, final Datamodel dm) throws XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param parent
	 *            The parent {@link State} for this invoke.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readInvoke(final XMLStreamReader reader, final Configuration configuration, final State parent) throws XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param parent
	 *            The parent {@link Invoke} for this param.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readParam(final XMLStreamReader reader, final Configuration configuration, final Invoke parent) throws XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param state
	 *            The {@link State} which contains the parent {@link Invoke}.
	 * @param invoke
	 *            The parent {@link Invoke} for this finalize.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readFinalize(final XMLStreamReader reader, final Configuration configuration, final State state, final Invoke invoke) throws XMLStreamException {
	 ...
	 *            The {@link State} which contains the parent {@link Invoke}.
	 * @param invoke
	 *            The parent {@link Invoke} for this content.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readContent(final XMLStreamReader reader, final Configuration configuration, final State state, final Invoke invoke) throws XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param state
	 *            The parent composite {@link State} for this initial.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readInitial(final XMLStreamReader reader, final Configuration configuration, final State state) throws XMLStreamException {
	 ...
	 *            The root of the object model being parsed.
	 * @param tt
	 *            The parent {@link TransitionTarget} for this history.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readHistory(final XMLStreamReader reader, final Configuration configuration, final SCXML scxml, final TransitionTarget tt) throws XMLStreamException {
	 ...
	 *            The root of the object model being parsed.
	 * @param tt
	 *            The parent {@link TransitionTarget} for this onentry.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readOnEntry(final XMLStreamReader reader, final Configuration configuration, final SCXML scxml, final TransitionTarget tt) throws XMLStreamException {
	 ...
	 *            The root of the object model being parsed.
	 * @param tt
	 *            The parent {@link TransitionTarget} for this onexit.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readOnExit(final XMLStreamReader reader, final Configuration configuration, final SCXML scxml, final TransitionTarget tt) throws XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param tt
	 *            The parent {@link TransitionTarget} for this transition.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readTransition(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt) throws XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param tt
	 *            The parent {@link TransitionTarget} for this executable
	 *            content.
	 * @param executable
	 *            The parent {@link Executable} to which this content belongs.
	 * @param iff
	 *            The optional parent {@link If} if this is child content of an
	 *            if action.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readExecutableContext(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff)
			throws XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param tt
	 *            The parent {@link TransitionTarget} for this action.
	 * @param executable
	 *            The parent {@link Executable} for this action.
	 * @param iff
	 *            The optional parent {@link If} if this action is a child of
	 *            one.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readEvent(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *            The parent {@link Executable} for this action.
	 * @param parent
	 *            The optional parent {@link If} if this &lt;if&gt; is a child
	 *            of another.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readIf(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If parent) throws XMLStreamException {
	 ...
	 *            The parent {@link Executable} for this action.
	 * @param iff
	 *            The parent {@link If} for this &lt;elseif&gt;.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readElseIf(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *            The parent {@link Executable} for this action.
	 * @param iff
	 *            The parent {@link If} for this &lt;else&gt;.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readElse(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readLog(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readAssign(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readValidate(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readSend(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readCancel(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readScript(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readVar(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void readExit(final XMLStreamReader reader, final Configuration configuration, final TransitionTarget tt, final Executable executable, final If iff) throws XMLStreamException {
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param customAction
	 *            The {@link CustomAction} to read.
	 * @param tt
	 *            The parent {@link TransitionTarget} for this custom action.
	 * @param executable
	 *            The parent {@link Executable} for this custom action.
	 * @param iff
	 *            The optional parent {@link If} if this custom action is a
	 *            child of one.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void readCustomAction(final XMLStreamReader reader, final Configuration configuration, final CustomAction customAction, final TransitionTarget tt, final Executable executable,
			final If iff) throws XMLStreamException {
		...
		for (int i = 0; i < reader.getAttributeCount(); i++) {
			...
			try {
				...
				throw new XMLStreamException("No setter in class:" + className + ", for string property:" + name, nsme);
			} catch (InvocationTargetException ite) {
				throw new XMLStreamException("Exception calling setter for string property:" + name + " in class:" + className, ite);
			} catch (IllegalAccessException iae) {
				throw new XMLStreamException("Cannot access setter for string property:" + name + " in class:" + className, iae);
			}
		}

		// Add any body content if necessary
		if (action instanceof ExternalContent) {
			Node body = readNode(reader, configuration, customAction.getNamespaceURI(), customAction.getLocalName(), new String[] {});
			NodeList childNodes = body.getChildNodes();
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param namespaceURI
	 *            The namespace URI of the parent element (we will stop parsing
	 *            into DOM nodes when we reach the corresponding end tag)
	 * @param localName
	 *            The local name of the parent element (we will stop parsing
	 *            into DOM nodes when we reach the corresponding end tag)
	 * @param attrs
	 *            The attributes that will be read into the root DOM node.
	 * 
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static Node readNode(final XMLStreamReader reader, final Configuration configuration, final String namespaceURI, final String localName, final String[] attrs) throws XMLStreamException {
		...
		// <data> can have only one child element, flags to skip any text nodes
		// on either side
		...
		loop: while (reader.hasNext()) {
			...
			case XMLStreamConstants.END_ELEMENT:
				...
				if (namespaceURI.equals(nsURI) && localName.equals(name))
					break loop;
				if (((nodeNSURI == null && nsURI == null) || (nodeNSURI != null && nodeNSURI.equals(nsURI))) && name.equals(nodeName))
					text = false;
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param namespaceURI
	 *            The namespace URI of the parent element (we will stop reading
	 *            content when we reach the corresponding end tag)
	 * @param localName
	 *            The local name of the parent element (we will stop reading
	 *            content when we reach the corresponding end tag)
	 * 
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static String readBody(final XMLStreamReader reader, final Configuration configuration, final String namespaceURI, final String localName) throws XMLStreamException {
		...
		loop: while (reader.hasNext()) {
			...
			case XMLStreamConstants.START_ELEMENT:
				...
				log.warn("Ignoring XML content in <script> element, encountered start tag with local name: " + reader.getLocalName());
				break;
			case XMLStreamConstants.SPACE:
			case XMLStreamConstants.CHARACTERS:
			case XMLStreamConstants.ENTITY_REFERENCE:
			...
			case XMLStreamConstants.END_ELEMENT:
				...
				log = LogFactory.getLog(SCXMLReader.class);
				log.warn("Ignoring XML content in <script> element, encountered end tag with local name: " + reader.getLocalName());
				break;
			default: // rest is ignored
			}
		}
	 ...
	 *            parse.
	 * @param attrLocalName
	 *            The attribute name whose value is needed.
	 * 
	...
	/**
	 * Read the current active namespace declarations into the namespace
	 * prefixes holder.
	 * 
	 * @param configuration
	 *            The {@link Configuration} to use while parsing.
	 * @param holder
	 *            The {@link NamespacePrefixesHolder} to populate.
	 */
	 ...
	 * the class {@link org.apache.commons.logging.Log}.
	 * 
	 * @param reader
	 *            The {@link XMLStreamReader} providing the SCXML document to
	 *            parse.
	 ...
	 *            The {@link Configuration} to use while parsing.
	 * @param parent
	 *            The parent element local name in the SCXML namespace.
	 * @param nsURI
	 *            The namespace URI of the ignored element.
	 * @param name
	 *            The local name of the ignored element.
	 * 
	 * @throws XMLStreamException
	 *             An exception processing the underlying
	 *             {@link XMLStreamReader}.
	 */
	private static void reportIgnoredElement(final XMLStreamReader reader, final Configuration configuration, final String parent, final String nsURI, final String name) throws XMLStreamException {

		org.apache.commons.logging.Log log = LogFactory.getLog(SCXMLReader.class);
		StringBuffer sb = new StringBuffer();
		sb.append("Ignoring element <").append(name).append("> in namespace \"").append(nsURI).append("\" as child ").append(" of <").append(parent).append("> at ").append(reader.getLocation());
	...
	/**
	 * Pop any expiring namespace declarations from the configuration namespaces
	 * map.
	 * 
	 * @param reader
	 *            The {@link XMLStreamReader} providing the SCXML document to
	 ...
	 *             {@link XMLStreamReader}.
	 */
	private static void popNamespaces(final XMLStreamReader reader, final Configuration configuration) throws XMLStreamException {
	...
	/**
	 * Use the supplied {@link Configuration} to create an appropriate
	 * {@link XMLStreamReader} for this {@link SCXMLReader}. Exactly one of the
	 * url, path, stream, reader or source parameters must be provided.
	 * 
	 * @param configuration
	 *            The {@link Configuration} to be used.
	 * @param url
	 *            The {@link URL} to the SCXML document to read.
	 * @param path
	 *            The optional real path to the SCXML document as a string.
	 * @param stream
	 *            The optional {@link InputStream} providing the SCXML document.
	 ...
	 * 
	 * @throws IOException
	 *             Exception with the URL IO.
	 * @throws XMLStreamException
	 *             A problem with the XML stream creation or an wrapped
	 *             {@link SAXException} thrown in trying to validate the
	 *             document against the XML Schema for SCXML.
	 */
	private static XMLStreamReader getReader(final Configuration configuration, final URL url, final String path, final InputStream stream, final Reader reader, final Source source)
	 ...
	 * necessary for the following are covered:
	 * </p>
	 * 
	 * <ul>
	 * <li>{@link XMLInputFactory} configuration properties such as
	 * {@link XMLReporter}, {@link XMLResolver} and {@link XMLEventAllocator}</li>
	 * <li>{@link XMLStreamReader} configuration properties such as
	 * <code>systemId</code> and <code>encoding</code></li>
	 * <li>Commons SCXML object model configuration properties such as the list
	 * of custom actions and the {@link PathResolver} to use.</li>
	 * </ul>
	 */
	public static class Configuration {
		...
		/**
		 * The {@link ClassLoader} to use for the {@link XMLInputFactory}
		 * instance to create.
		 */
		...
		/**
		 * @param allocator
		 *            The {@link XMLEventAllocator} for the
		 *            {@link XMLInputFactory}.
		 */
		final XMLEventAllocator allocator;

		/**
		 * The map of properties (keys are property name strings, values are
		 * object property values) for the {@link XMLInputFactory}.
		 */
		...
		/**
		 * The {@link ClassLoader} to use for loading the {@link CustomAction}
		 * instances to create.
		 */
		final ClassLoader customActionClassLoader;

		/**
		 * Whether to use the thread context {@link ClassLoader} for loading any
		 * {@link CustomAction} classes.
		 */
		final boolean useContextClassLoaderForCustomActions;

		/**
		 * The map for bookkeeping the current active namespace declarations.
		 * The keys are prefixes and the values are {@link Stack}s containing
		 * the corresponding namespaceURIs, with the active one on top.
		 */
		 ...
		 * &lt;state&gt; or &lt;parallel&gt; element's "src" attribute.
		 */
		SCXML parent;
		 ...
		 * 
		 * @param reporter
		 *            The {@link XMLReporter} to use for this reading.
		 * @param pathResolver
		 *            The Commons SCXML {@link PathResolver} to use for this
		 *            reading.
		 */
		 ...
		 *            reading.
		 * @param customActions
		 *            The list of Commons SCXML custom actions that will be
		 *            available for this document.
		 */
		public Configuration(final XMLReporter reporter, final PathResolver pathResolver, final List<CustomAction> customActions) {
			this(null, null, null, null, null, reporter, null, null, false, pathResolver, null, customActions, null, false);
		}

		/**
		 * All purpose constructor. Any of the parameters passed in can be
		 * <code>null</code> (booleans should default to <code>false</code>).
		 * 
		 * @param factoryId
		 *            The <code>factoryId</code> to use.
		 * @param classLoader
		 *            The {@link ClassLoader} to use for the
		 *            {@link XMLInputFactory} instance to create.
		 * @param allocator
		 *            The {@link XMLEventAllocator} for the
		 *            {@link XMLInputFactory}.
		 * @param properties
		 *            The map of properties (keys are property name strings,
		 *            values are object property values) for the
		 *            {@link XMLInputFactory}.
		 * @param resolver
		 *            The {@link XMLResolver} for the {@link XMLInputFactory}.
		 * @param reporter
		 *            The {@link XMLReporter} for the {@link XMLInputFactory}.
		 * @param encoding
		 *            The <code>encoding</code> to use for the
		 *            {@link XMLStreamReader}
		 * @param systemId
		 *            The <code>systemId</code> to use for the
		 *            {@link XMLStreamReader}
		 * @param validate
		 *            Whether to validate the input with the XML Schema for
		 *            SCXML.
		 * @param pathResolver
		 *            The Commons SCXML {@link PathResolver} to use for this
		 *            document.
		 ...
		 *            The list of Commons SCXML custom actions that will be
		 *            available for this document.
		 * @param customActionClassLoader
		 *            The {@link ClassLoader} to use for the
		 *            {@link CustomAction} instances to create.
		 * @param useContextClassLoaderForCustomActions
		 *            Whether to use the thread context {@link ClassLoader} for
		 *            the {@link CustomAction} instances to create.
		 */
		public Configuration(final String factoryId, final ClassLoader classLoader, final XMLEventAllocator allocator, final Map<String, Object> properties, final XMLResolver resolver,
				final XMLReporter reporter, final String encoding, final String systemId, final boolean validate, final PathResolver pathResolver, final List<CustomAction> customActions,
				final ClassLoader customActionClassLoader, final boolean useContextClassLoaderForCustomActions) {
			this(factoryId, classLoader, allocator, properties, resolver, reporter, encoding, systemId, validate, pathResolver, null, customActions, customActionClassLoader,
		 ...
		 *            document.
		 * @param parent
		 *            The parent SCXML document if this document is src'ed in
		 *            via the &lt;state&gt; or &lt;parallel&gt; element's "src"
		 *            attribute.
		 */
		 ...
		 * 
		 * @param source
		 *            The source {@link Configuration} to replicate.
		 */
		Configuration(final Configuration source) {
			this(source.factoryId, source.factoryClassLoader, source.allocator, source.properties, source.resolver, source.reporter, source.encoding, source.systemId, source.validate,
					source.pathResolver, source.parent, source.customActions, source.customActionClassLoader, source.useContextClassLoaderForCustomActions);
		}
		 ...
		 *            the {@link CustomAction} instances to create.
		 */
		Configuration(final String factoryId, final ClassLoader factoryClassLoader, final XMLEventAllocator allocator, final Map<String, Object> properties, final XMLResolver resolver,
				final XMLReporter reporter, final String encoding, final String systemId, final boolean validate, final PathResolver pathResolver, final SCXML parent,
				final List<CustomAction> customActions, final ClassLoader customActionClassLoader, final boolean useContextClassLoaderForCustomActions) {
		 ...
		 * 
		 * @return Map<String,String> The namespace map (keys are prefixes and
		 *         values are the corresponding current namespace URIs).
		 */
