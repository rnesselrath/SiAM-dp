...
/**
 * The registry where SCXML listeners are recorded for nodes of interest such as
 * the <code>SCXML</code> root, <code>TransitionTarget</code>s and
 * <code>Transition</code>s. The notification registry keeps track of all
 * <code>SCXMLListener</code>s attached and notifies relevant listeners of the
...
public final class NotificationRegistry implements Serializable {
	 ...
	 * 
	 * @param source
	 *            The observable this listener wants to listen to
	 * @param lst
	 *            The listener
	 */
	 ...
	 * 
	 * @param source
	 *            The observable this listener wants to stop listening to
	 * @param lst
	 *            The listener
	 */
	 ...
	 *            The Observable
	 * @param state
	 *            The TransitionTarget that was entered
	 */
	public synchronized void fireOnEntry(final Observable source, final TransitionTarget state) {
		Set<SCXMLListener> entries = regs.get(source);
		if (entries != null) {
	 ...
	 *            The Observable
	 * @param state
	 *            The TransitionTarget that was exited
	 */
	public synchronized void fireOnExit(final Observable source, final TransitionTarget state) {
		Set<SCXMLListener> entries = regs.get(source);
		if (entries != null) {
			for (SCXMLListener lst : entries) {
				lst.onExit(state);
	 ...
	 *            The Observable
	 * @param from
	 *            The source TransitionTarget
	 * @param to
	 *            The destination TransitionTarget
	 * @param transition
	 *            The Transition that was taken
	 */
	public synchronized void fireOnTransition(final Observable source, final TransitionTarget from, final TransitionTarget to, final Transition transition) {
		Set<SCXMLListener> entries = regs.get(source);
		if (entries != null) {
			for (SCXMLListener lst : entries) {
	 ...
	 *            The Transition that was taken
	 */
	public synchronized void fireOnStable(final Observable source) {
		Set<SCXMLListener> entries = regs.get(source);
		if (entries != null) {
			for (SCXMLListener lst : entries) {
				lst.onStable();
