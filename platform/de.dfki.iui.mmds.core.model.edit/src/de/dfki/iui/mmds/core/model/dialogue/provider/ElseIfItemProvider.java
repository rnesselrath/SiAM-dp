...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.dialogue.ElseIf} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElseIfItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ElseIf_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ElseIf_condition_feature", "_UI_ElseIf_type"),
				 DialoguePackage.Literals.ELSE_IF__CONDITION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DialoguePackage.Literals.ELSE_IF__CONTENT);
		}
	...
	public String getText(Object object) {
		String label = ((ElseIf)object).getCondition();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ElseIf.class)) {
			case DialoguePackage.ELSE_IF__CONDITION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DialoguePackage.ELSE_IF__CONTENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DialoguePackage.Literals.ELSE_IF__CONTENT,
