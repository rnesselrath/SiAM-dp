...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.base.Session} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SessionItemProvider extends EntityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Session_participants_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Session_participants_feature", "_UI_Session_type"),
				 BasePackage.Literals.SESSION__PARTICIPANTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSessionIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Session_sessionID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Session_sessionID_feature", "_UI_Session_type"),
				 BasePackage.Literals.SESSION__SESSION_ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		BString labelValue = ((Session)object).getSessionID();
