...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io_interfaces.VentilatorControl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VentilatorControlItemProvider extends BObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VentilatorControlItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VentilatorControl_level_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VentilatorControl_level_feature", "_UI_VentilatorControl_type"),
				 Io_interfacesPackage.Literals.VENTILATOR_CONTROL__LEVEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns VentilatorControl.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VentilatorControl"));
	}
	...
	public String getText(Object object) {
		String label = ((VentilatorControl)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_VentilatorControl_type") :
			getString("_UI_VentilatorControl_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VentilatorControl.class)) {
