 ...
 * {@link de.dfki.iui.mmds.core.model.io.gui.GUIApplication} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class GUIApplicationItemProvider extends BObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GUIApplicationItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addStyleResourcePropertyDescriptor(object);
		}
	...
	protected void addWindowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GUIApplication_window_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GUIApplication_window_feature", "_UI_GUIApplication_type"),
				 GuiPackage.Literals.GUI_APPLICATION__WINDOW,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addApplicationIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GUIApplication_applicationId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GUIApplication_applicationId_feature", "_UI_GUIApplication_type"),
				 GuiPackage.Literals.GUI_APPLICATION__APPLICATION_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Style Resource feature. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addStyleResourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GUIApplication_styleResource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GUIApplication_styleResource_feature", "_UI_GUIApplication_type"),
				 GuiPackage.Literals.GUI_APPLICATION__STYLE_RESOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuiPackage.Literals.GUI_APPLICATION__WINDOW);
		}
	...
	/**
	 * This returns GUIApplication.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GUIApplication"));
	}
	...
	public String getText(Object object) {
		String label = ((GUIApplication)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_GUIApplication_type") :
			getString("_UI_GUIApplication_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GUIApplication.class)) {
