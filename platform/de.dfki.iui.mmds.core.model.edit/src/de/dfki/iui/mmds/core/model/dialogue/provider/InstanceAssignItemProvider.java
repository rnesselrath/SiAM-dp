...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.dialogue.InstanceAssign} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceAssignItemProvider 
	 ...
	 * @generated
	 */
	public InstanceAssignItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCopyOfPropertyDescriptor(object);
		}
...
//			(createItemPropertyDescriptor
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstanceAssign_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstanceAssign_to_feature", "_UI_InstanceAssign_type"),
				 DialoguePackage.Literals.INSTANCE_ASSIGN__TO,
				 true,
				 false,
				 false,
			...
			public Collection<?> getChoiceOfValues(Object object) {
				...
				varNames.add(null);
				InstanceAssign instModFeat = (InstanceAssign) object;
	...
	/**
	 * This adds a property descriptor for the Copy Of feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCopyOfPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstanceAssign_copyOf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstanceAssign_copyOf_feature", "_UI_InstanceAssign_type"),
				 DialoguePackage.Literals.INSTANCE_ASSIGN__COPY_OF,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DialoguePackage.Literals.INSTANCE_ASSIGN__INSTANCE);
		}
	...
	/**
	 * This returns InstanceAssign.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InstanceAssign"));
	}
	...
	public String getText(Object object) {
		String label = ((InstanceAssign)object).getTo();
		return label == null || label.length() == 0 ?
			getString("_UI_InstanceAssign_type") :
			getString("_UI_InstanceAssign_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InstanceAssign.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DialoguePackage.Literals.INSTANCE_ASSIGN__INSTANCE,
