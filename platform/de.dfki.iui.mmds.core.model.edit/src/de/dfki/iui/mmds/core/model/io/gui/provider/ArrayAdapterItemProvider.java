...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.gui.ArrayAdapter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayAdapterItemProvider
	 ...
	 * @generated
	 */
	public ArrayAdapterItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArrayAdapter_expression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArrayAdapter_expression_feature", "_UI_ArrayAdapter_type"),
				 GuiPackage.Literals.ARRAY_ADAPTER__EXPRESSION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuiPackage.Literals.ARRAY_ADAPTER__ELEMENT);
			childrenFeatures.add(GuiPackage.Literals.ARRAY_ADAPTER__PATTERN);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ArrayAdapter"));
	}
	...
	public String getText(Object object) {
		String label = ((ArrayAdapter)object).getExpression();
		return label == null || label.length() == 0 ?
			getString("_UI_ArrayAdapter_type") :
			getString("_UI_ArrayAdapter_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ArrayAdapter.class)) {
			case GuiPackage.ARRAY_ADAPTER__EXPRESSION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case GuiPackage.ARRAY_ADAPTER__ELEMENT:
			case GuiPackage.ARRAY_ADAPTER__PATTERN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuiPackage.Literals.ARRAY_ADAPTER__ELEMENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(GuiPackage.Literals.ARRAY_ADAPTER__PATTERN,
