...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.UpdateDeviceMode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateDeviceModeItemProvider
	 ...
	 * @generated
	 */
	public UpdateDeviceModeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IoPackage.Literals.UPDATE_DEVICE_MODE__DEVICE_MODE);
		}
	...
	/**
	 * This returns UpdateDeviceMode.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateDeviceMode"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateDeviceMode)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateDeviceMode_type") :
			getString("_UI_UpdateDeviceMode_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UpdateDeviceMode.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IoPackage.Literals.UPDATE_DEVICE_MODE__DEVICE_MODE,
