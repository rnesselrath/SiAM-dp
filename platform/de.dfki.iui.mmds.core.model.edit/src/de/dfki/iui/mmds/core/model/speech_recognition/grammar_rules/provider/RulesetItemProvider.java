...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.speech_recognition.grammar_rules.Ruleset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RulesetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ruleset_identifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ruleset_identifier_feature", "_UI_Ruleset_type"),
				 Grammar_rulesPackage.Literals.RULESET__IDENTIFIER,
				 true,
				 false,
				 false,
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ruleset_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ruleset_language_feature", "_UI_Ruleset_type"),
				 Grammar_rulesPackage.Literals.RULESET__LANGUAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Grammar_rulesPackage.Literals.RULESET__RULES);
		}
	...
	public String getText(Object object) {
		String label = ((Ruleset)object).getIdentifier();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Grammar_rulesPackage.Literals.RULESET__RULES,
