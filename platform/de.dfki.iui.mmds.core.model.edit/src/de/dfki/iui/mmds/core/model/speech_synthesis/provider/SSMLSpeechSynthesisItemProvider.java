...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.speech_synthesis.SSMLSpeechSynthesis} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SSMLSpeechSynthesisItemProvider extends BObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SSMLSpeechSynthesisItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSsmlPropertyDescriptor(object);
			addSsmlDocumentPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Ssml feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSsmlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SSMLSpeechSynthesis_ssml_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SSMLSpeechSynthesis_ssml_feature", "_UI_SSMLSpeechSynthesis_type"),
				 SpeechSynthesisPackage.Literals.SSML_SPEECH_SYNTHESIS__SSML,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Ssml Document feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSsmlDocumentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SSMLSpeechSynthesis_ssmlDocument_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SSMLSpeechSynthesis_ssmlDocument_feature", "_UI_SSMLSpeechSynthesis_type"),
				 SpeechSynthesisPackage.Literals.SSML_SPEECH_SYNTHESIS__SSML_DOCUMENT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SSMLSpeechSynthesis.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SSMLSpeechSynthesis"));
	}
	...
	public String getText(Object object) {
		String label = ((SSMLSpeechSynthesis)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_SSMLSpeechSynthesis_type") :
			getString("_UI_SSMLSpeechSynthesis_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SSMLSpeechSynthesis.class)) {
