...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.dialogue.DoWhile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DoWhileItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DoWhile_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DoWhile_condition_feature", "_UI_DoWhile_type"),
				 DialoguePackage.Literals.DO_WHILE__CONDITION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DialoguePackage.Literals.DO_WHILE__BODY);
		}
	...
	public String getText(Object object) {
		String label = ((DoWhile)object).getDisplayName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DialoguePackage.Literals.DO_WHILE__BODY,
