 ...
 * {@link de.dfki.iui.mmds.core.model.dialogue.Sequence} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SequenceItemProvider extends NodeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DialoguePackage.Literals.SEQUENCE__CONTENT);
		}
	...
	public String getText(Object object) {
		String label = ((Sequence)object).getDisplayName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Sequence.class)) {
			case DialoguePackage.SEQUENCE__CONTENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DialoguePackage.Literals.SEQUENCE__CONTENT,
