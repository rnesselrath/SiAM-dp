...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.project.OutputMappingRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputMappingRuleItemProvider 
	 ...
	 * @generated
	 */
	public OutputMappingRuleItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProjectPackage.Literals.OUTPUT_MAPPING_RULE__TARGET);
		}
	...
	/**
	 * This returns OutputMappingRule.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OutputMappingRule"));
	}
	...
	public String getText(Object object) {
		String label = ((OutputMappingRule)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_OutputMappingRule_type") :
			getString("_UI_OutputMappingRule_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OutputMappingRule.class)) {
			case ProjectPackage.OUTPUT_MAPPING_RULE__DESCRIPTION:
			case ProjectPackage.OUTPUT_MAPPING_RULE__ACTIVE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ProjectPackage.OUTPUT_MAPPING_RULE__CONDITION:
			case ProjectPackage.OUTPUT_MAPPING_RULE__TARGET:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProjectPackage.Literals.OUTPUT_MAPPING_RULE__TARGET,
