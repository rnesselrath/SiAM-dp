 ...
 * {@link de.dfki.iui.mmds.core.model.dialogue.Raise} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class RaiseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DialoguePackage.Literals.RAISE__EVENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return slotName + (label == null || label.length() == 0 ? getString("_UI_Raise_type") : getString("_UI_Raise_type") + " " + label);
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Raise.class)) {
			case DialoguePackage.RAISE__EVENT:
