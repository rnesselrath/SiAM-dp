 ...
 * {@link de.dfki.iui.mmds.core.model.pattern.PBooleanRestriction} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PBooleanRestrictionItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_PBooleanRestriction_type") : label + " " + ((PBooleanRestriction) object).getValue();
	}
