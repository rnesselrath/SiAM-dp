...
import de.dfki.iui.mmds.core.model.base.provider.NamedEntityItemProvider;
...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.task.TPhysicalEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TPhysicalEntityItemProvider extends NamedEntityItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TPhysicalEntityItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TMetaData_media_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TMetaData_media_feature", "_UI_TMetaData_type"),
				 TaskPackage.Literals.TMETA_DATA__MEDIA,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TaskPackage.Literals.TMETA_DATA__DESCRIPTION);
			childrenFeatures.add(TaskPackage.Literals.TMETA_DATA__HISTORY);
		}
	...
	public String getText(Object object) {
		BString labelValue = ((TPhysicalEntity)object).getName();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_TPhysicalEntity_type") :
			getString("_UI_TPhysicalEntity_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TPhysicalEntity.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TaskPackage.Literals.TMETA_DATA__DESCRIPTION,
				 TaskFactory.eINSTANCE.createTDescription()));

		newChildDescriptors.add
			(createChildParameter
				(TaskPackage.Literals.TMETA_DATA__HISTORY,
