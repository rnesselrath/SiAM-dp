...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.tangible.TangibleInput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TangibleInputItemProvider
	 ...
	 * @generated
	 */
	public TangibleInputItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHardwareTypePropertyDescriptor(object);
			addHardwareFriendlyNamePropertyDescriptor(object);
		}
	...
	protected void addHardwareIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TangibleInput_hardwareID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TangibleInput_hardwareID_feature", "_UI_TangibleInput_type"),
				 TangiblePackage.Literals.TANGIBLE_INPUT__HARDWARE_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Hardware Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHardwareTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TangibleInput_hardwareType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TangibleInput_hardwareType_feature", "_UI_TangibleInput_type"),
				 TangiblePackage.Literals.TANGIBLE_INPUT__HARDWARE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Hardware Friendly Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHardwareFriendlyNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TangibleInput_hardwareFriendlyName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TangibleInput_hardwareFriendlyName_feature", "_UI_TangibleInput_type"),
				 TangiblePackage.Literals.TANGIBLE_INPUT__HARDWARE_FRIENDLY_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns TangibleInput.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TangibleInput"));
	}
	...
	public String getText(Object object) {
		String label = ((TangibleInput)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_TangibleInput_type") :
			getString("_UI_TangibleInput_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TangibleInput.class)) {
