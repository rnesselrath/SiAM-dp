...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.references.TemporalReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TemporalReferenceItemProvider 
	 ...
	 * @generated
	 */
	public TemporalReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTemporalFramePropertyDescriptor(object);
		}
	...
	protected void addNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TemporalReference_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TemporalReference_number_feature", "_UI_TemporalReference_type"),
				 ReferencesPackage.Literals.TEMPORAL_REFERENCE__NUMBER,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Temporal Frame feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTemporalFramePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TemporalReference_temporalFrame_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TemporalReference_temporalFrame_feature", "_UI_TemporalReference_type"),
				 ReferencesPackage.Literals.TEMPORAL_REFERENCE__TEMPORAL_FRAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TemporalReference_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TemporalReference_unit_feature", "_UI_TemporalReference_type"),
				 ReferencesPackage.Literals.TEMPORAL_REFERENCE__UNIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns TemporalReference.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TemporalReference"));
	}
	...
	public String getText(Object object) {
		TemporalReference temporalReference = (TemporalReference)object;
		return getString("_UI_TemporalReference_type") + " " + temporalReference.isIsMany();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TemporalReference.class)) {
