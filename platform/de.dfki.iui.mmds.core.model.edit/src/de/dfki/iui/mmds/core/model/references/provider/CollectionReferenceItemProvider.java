...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.references.CollectionReference} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class CollectionReferenceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
		IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public CollectionReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollectionReference_position_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollectionReference_position_feature", "_UI_CollectionReference_type"),
				 ReferencesPackage.Literals.COLLECTION_REFERENCE__POSITION,
				 true,
				 false,
				 false,
	...
	protected void addOrderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollectionReference_order_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollectionReference_order_feature", "_UI_CollectionReference_type"),
				 ReferencesPackage.Literals.COLLECTION_REFERENCE__ORDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns CollectionReference.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CollectionReference"));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_CollectionReference_type") + " " + collectionReference.isIsMany();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CollectionReference.class)) {
