...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.gui.ButtonBar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonBarItemProvider
	 ...
	 * @generated
	 */
	public ButtonBarItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ButtonBar_orientation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ButtonBar_orientation_feature", "_UI_ButtonBar_type"),
				 GuiPackage.Literals.BUTTON_BAR__ORIENTATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuiPackage.Literals.BUTTON_BAR__BUTTON);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ButtonBar"));
	}
	...
	public String getText(Object object) {
		BString labelValue = ((ButtonBar)object).getId();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ButtonBar_type") :
			getString("_UI_ButtonBar_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ButtonBar.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuiPackage.Literals.BUTTON_BAR__BUTTON,
