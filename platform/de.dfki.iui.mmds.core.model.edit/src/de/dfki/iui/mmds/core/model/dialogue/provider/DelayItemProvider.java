 ...
 * {@link de.dfki.iui.mmds.core.model.dialogue.Delay} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DelayItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DialoguePackage.Literals.DELAY__DURATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		BInteger labelValue = ((Delay) object).getDuration();
		String label = labelValue == null ? null : labelValue.toString();
		return slotName + (label == null || label.length() == 0 ? getString("_UI_Delay_type") : getString("_UI_Delay_type") + " " + label);
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Delay.class)) {
			case DialoguePackage.DELAY__DURATION:
