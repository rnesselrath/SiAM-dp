...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io_interfaces.LampControl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LampControlItemProvider extends BObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LampControlItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOnStatePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the On State feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOnStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LampControl_onState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LampControl_onState_feature", "_UI_LampControl_type"),
				 Io_interfacesPackage.Literals.LAMP_CONTROL__ON_STATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LampControl_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LampControl_color_feature", "_UI_LampControl_type"),
				 Io_interfacesPackage.Literals.LAMP_CONTROL__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LampControl"));
	}
	...
	public String getText(Object object) {
		String label = ((LampControl)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_LampControl_type") :
			getString("_UI_LampControl_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LampControl.class)) {
