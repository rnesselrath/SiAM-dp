...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io_interfaces.BodyGesture} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BodyGestureItemProvider extends BObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public BodyGestureItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BodyGesture"));
	}
	...
	public String getText(Object object) {
		String label = ((BodyGesture)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_BodyGesture_type") :
			getString("_UI_BodyGesture_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BodyGesture.class)) {
