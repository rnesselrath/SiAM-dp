...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.gui.TextInput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextInputItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GuiPackage.Literals.TEXT_INPUT__TEXT,
				 true,
				 false,
				 false,
	...
	protected void addMultiLinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextInput_multiLine_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextInput_multiLine_feature", "_UI_TextInput_type"),
				 GuiPackage.Literals.TEXT_INPUT__MULTI_LINE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuiPackage.Literals.TEXT_INPUT__SOFT_KEYBOARD);
		}
	...
	public String getText(Object object) {
		BString labelValue = ((TextInput)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuiPackage.Literals.TEXT_INPUT__SOFT_KEYBOARD,
