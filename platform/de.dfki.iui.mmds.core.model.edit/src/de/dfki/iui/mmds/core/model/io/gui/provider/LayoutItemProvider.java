...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.gui.Layout} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayoutItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Layout_height_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Layout_height_feature", "_UI_Layout_type"),
				 GuiPackage.Literals.LAYOUT__HEIGHT,
				 true,
				 false,
				 false,
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Layout_width_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Layout_width_feature", "_UI_Layout_type"),
				 GuiPackage.Literals.LAYOUT__WIDTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addHorizontalAlignmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Layout_horizontalAlignment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Layout_horizontalAlignment_feature", "_UI_Layout_type"),
				 GuiPackage.Literals.LAYOUT__HORIZONTAL_ALIGNMENT,
				 true,
				 false,
				 false,
	...
	protected void addVerticalAlignmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Layout_verticalAlignment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Layout_verticalAlignment_feature", "_UI_Layout_type"),
				 GuiPackage.Literals.LAYOUT__VERTICAL_ALIGNMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuiPackage.Literals.LAYOUT__MARGIN);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Layout_type") + " " + layout.getHeight();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuiPackage.Literals.LAYOUT__MARGIN,
