...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.gui.Size} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SizeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GuiPackage.Literals.SIZE__HEIGHT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GuiPackage.Literals.SIZE__WIDTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Size_type") + " " + size.getHeight();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Size.class)) {
			case GuiPackage.SIZE__HEIGHT:
			case GuiPackage.SIZE__WIDTH:
