...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.gui.GUIEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GUIEventItemProvider
	 ...
	 * @generated
	 */
	public GUIEventItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEventDataPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Event Data feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEventDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GUIEvent_eventData_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GUIEvent_eventData_feature", "_UI_GUIEvent_type"),
				 GuiPackage.Literals.GUI_EVENT__EVENT_DATA,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GUIEvent"));
	}
	...
	public String getText(Object object) {
		String label = ((GUIEvent)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_GUIEvent_type") :
			getString("_UI_GUIEvent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GUIEvent.class)) {
