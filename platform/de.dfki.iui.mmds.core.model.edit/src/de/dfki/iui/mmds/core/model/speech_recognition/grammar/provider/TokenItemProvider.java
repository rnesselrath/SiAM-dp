...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.speech_recognition.grammar.Token} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TokenItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Token_lang_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Token_lang_feature", "_UI_Token_type"),
				 GrammarPackage.Literals.TOKEN__LANG,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GrammarPackage.Literals.TOKEN__MIXED);
		}
	...
	public String getText(Object object) {
		String label = ((Token)object).getLang();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Token.class)) {
			case GrammarPackage.TOKEN__LANG:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case GrammarPackage.TOKEN__MIXED:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GrammarPackage.Literals.TOKEN__MIXED,
