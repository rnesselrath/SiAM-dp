...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.CompoundService} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompoundServiceItemProvider 
	 ...
	 * @generated
	 */
	public CompoundServiceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addServicesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompoundService_services_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompoundService_services_feature", "_UI_CompoundService_type"),
				 IoPackage.Literals.COMPOUND_SERVICE__SERVICES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns CompoundService.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompoundService"));
	}
	...
	public String getText(Object object) {
		String label = ((CompoundService)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_CompoundService_type") :
			getString("_UI_CompoundService_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompoundService.class)) {
