...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io_interfaces.SpeechSynthesis} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpeechSynthesisItemProvider extends BObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SpeechSynthesisItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addUtterancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SpeechSynthesis_utterance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SpeechSynthesis_utterance_feature", "_UI_SpeechSynthesis_type"),
				 Io_interfacesPackage.Literals.SPEECH_SYNTHESIS__UTTERANCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns SpeechSynthesis.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SpeechSynthesis"));
	}
	...
	public String getText(Object object) {
		String label = ((SpeechSynthesis)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_SpeechSynthesis_type") :
			getString("_UI_SpeechSynthesis_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SpeechSynthesis.class)) {
