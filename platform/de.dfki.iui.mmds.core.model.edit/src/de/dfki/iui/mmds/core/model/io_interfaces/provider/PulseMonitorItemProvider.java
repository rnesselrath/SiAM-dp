...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io_interfaces.PulseMonitor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PulseMonitorItemProvider extends BObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PulseMonitorItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPulsePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Pulse feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPulsePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PulseMonitor_pulse_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PulseMonitor_pulse_feature", "_UI_PulseMonitor_type"),
				 Io_interfacesPackage.Literals.PULSE_MONITOR__PULSE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PulseMonitor"));
	}
	...
	public String getText(Object object) {
		String label = ((PulseMonitor)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_PulseMonitor_type") :
			getString("_UI_PulseMonitor_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PulseMonitor.class)) {
