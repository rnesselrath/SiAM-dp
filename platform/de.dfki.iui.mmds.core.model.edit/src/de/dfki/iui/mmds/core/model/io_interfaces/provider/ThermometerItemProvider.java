...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io_interfaces.Thermometer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThermometerItemProvider extends BObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ThermometerItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTemperaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Thermometer_temperature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Thermometer_temperature_feature", "_UI_Thermometer_type"),
				 Io_interfacesPackage.Literals.THERMOMETER__TEMPERATURE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Thermometer_Unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Thermometer_Unit_feature", "_UI_Thermometer_type"),
				 Io_interfacesPackage.Literals.THERMOMETER__UNIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Thermometer"));
	}
	...
	public String getText(Object object) {
		String label = ((Thermometer)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_Thermometer_type") :
			getString("_UI_Thermometer_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Thermometer.class)) {
