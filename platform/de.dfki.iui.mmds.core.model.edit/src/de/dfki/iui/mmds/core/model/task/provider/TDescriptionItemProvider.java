...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.task.TDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TDescriptionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TDescription_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TDescription_value_feature", "_UI_TDescription_type"),
				 TaskPackage.Literals.TDESCRIPTION__VALUE,
				 true,
				 true,
				 false,
	...
	public String getText(Object object) {
		String label = crop(((TDescription)object).getValue());
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TDescription.class)) {
			case TaskPackage.TDESCRIPTION__VALUE:
