...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io_interfaces.VirtualCharacter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualCharacterItemProvider extends BObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VirtualCharacterItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAvatarIdPropertyDescriptor(object);
			addCameraPropertyDescriptor(object);
			addBmlPropertyDescriptor(object);
		}
	...
	protected void addUtterancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VirtualCharacter_utterance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualCharacter_utterance_feature", "_UI_VirtualCharacter_type"),
				 Io_interfacesPackage.Literals.VIRTUAL_CHARACTER__UTTERANCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Avatar Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAvatarIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VirtualCharacter_avatarId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualCharacter_avatarId_feature", "_UI_VirtualCharacter_type"),
				 Io_interfacesPackage.Literals.VIRTUAL_CHARACTER__AVATAR_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCameraPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VirtualCharacter_camera_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualCharacter_camera_feature", "_UI_VirtualCharacter_type"),
				 Io_interfacesPackage.Literals.VIRTUAL_CHARACTER__CAMERA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Bml feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBmlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VirtualCharacter_bml_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualCharacter_bml_feature", "_UI_VirtualCharacter_type"),
				 Io_interfacesPackage.Literals.VIRTUAL_CHARACTER__BML,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns VirtualCharacter.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VirtualCharacter"));
	}
	...
	public String getText(Object object) {
		String label = ((VirtualCharacter)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_VirtualCharacter_type") :
			getString("_UI_VirtualCharacter_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VirtualCharacter.class)) {
