...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.io.IOEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IOEventItemProvider
	 ...
	 * @generated
	 */
	public IOEventItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IoPackage.Literals.IO_EVENT__MESSAGE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IOEvent"));
	}
	...
	public String getText(Object object) {
		String label = ((IOEvent)object).getBinding();
		return label == null || label.length() == 0 ?
			getString("_UI_IOEvent_type") :
			getString("_UI_IOEvent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IOEvent.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IoPackage.Literals.IO_EVENT__MESSAGE,
