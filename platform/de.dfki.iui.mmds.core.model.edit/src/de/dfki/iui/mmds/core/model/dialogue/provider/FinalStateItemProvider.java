...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.dialogue.FinalState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FinalStateItemProvider
	extends DialogueDesignerElementItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((FinalState)object).getDisplayName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FinalState.class)) {
			case DialoguePackage.FINAL_STATE__VARIABLES:
