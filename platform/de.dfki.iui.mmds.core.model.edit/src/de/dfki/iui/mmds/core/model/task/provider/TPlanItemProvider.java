...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.task.TPlan} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TPlanItemProvider 
	extends TMetaDataItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TaskPackage.Literals.TPLAN__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TaskPackage.Literals.TPLAN__TASK);
		}
	...
	public String getText(Object object) {
		String label = ((TPlan)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TPlan.class)) {
			case TaskPackage.TPLAN__ID:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case TaskPackage.TPLAN__TASK:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TaskPackage.Literals.TPLAN__TASK,
