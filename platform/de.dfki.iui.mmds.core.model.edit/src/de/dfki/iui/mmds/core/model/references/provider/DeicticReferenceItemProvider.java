...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.mmds.core.model.references.DeicticReference} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DeicticReferenceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
		IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public DeicticReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DeicticReference.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeicticReference"));
	}
	...
	public String getText(Object object) {
		DeicticReference deicticReference = (DeicticReference)object;
		return getString("_UI_DeicticReference_type") + " " + deicticReference.isIsMany();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeicticReference.class)) {
