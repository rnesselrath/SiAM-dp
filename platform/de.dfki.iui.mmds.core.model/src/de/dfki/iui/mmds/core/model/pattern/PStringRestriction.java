 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.PStringRestriction#isIgnoreCase <em>Ignore Case</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.PStringRestriction#getValue <em>Value</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.PStringRestriction#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.mmds.core.model.pattern.PatternPackage#getPStringRestriction()
 * @model superTypes="de.dfki.iui.mmds.core.model.pattern.PRestriction<de.dfki.iui.mmds.core.model.pattern.PStringRestrictionEnum, de.dfki.iui.mmds.core.model.base.BString>"
 * @generated
 */
public interface PStringRestriction extends PRestriction<PStringRestrictionEnum, BString> {
	 ...
	 * @see de.dfki.iui.mmds.core.model.pattern.PatternPackage#getPStringRestriction_IgnoreCase()
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.mmds.core.model.pattern.PStringRestriction#isIgnoreCase <em>Ignore Case</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.iui.mmds.core.model.pattern.PatternPackage#getPStringRestriction_Value()
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.mmds.core.model.pattern.PStringRestriction#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link de.dfki.iui.mmds.core.model.pattern.PStringRestrictionEnum}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.iui.mmds.core.model.pattern.PatternPackage#getPStringRestriction_Function()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.mmds.core.model.pattern.PStringRestriction#getFunction <em>Function</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='if (value instanceof String || value instanceof de.dfki.iui.mmds.core.emf.datatypes.BString) {\r\n\tString p = getValue().getValue();\r\n\tString v = (String)value.toString();\r\n\tif (this.ignoreCase) {\r\n\t\tv = v.toLowerCase();\r\n\t\tp = p.toLowerCase();\r\n\t}\r\n\tswitch (getFunction()) {\r\n\tcase CONTAINS:\r\n\t\treturn v.contains(p);\t\t\t\t\r\n\tcase ENDS_WITH:\r\n\t\treturn v.endsWith(p);\r\n\tcase EQUALS:\r\n\t\treturn v.equals(p);\r\n\tcase MATCHES:\r\n\t\treturn v.matches(p);\r\n\tcase NOT_EQUALS:\r\n\t\treturn !v.equals(p);\r\n\tcase STARTS_WITH:\r\n\t\treturn v.startsWith(p);\r\n\tdefault:\r\n\t\treturn false;\r\n\t}\r\n}\r\nreturn false;'"
	 * @generated
	 */
