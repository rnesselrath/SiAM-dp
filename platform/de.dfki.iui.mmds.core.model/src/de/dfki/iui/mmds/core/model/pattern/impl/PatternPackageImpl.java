...
public class PatternPackageImpl extends EPackageImpl implements PatternPackage {
	 ...
	 * @generated
	 */
	private EClass pLogicalFormulaEClass = null;
	 ...
	 * @generated
	 */
	private EClass pSubscriptionEClass = null;
	 ...
	 * @see de.dfki.iui.mmds.core.model.pattern.PatternPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getPLogicalFormula() {
		return pLogicalFormulaEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getPLogicalFormula_Operator() {
		return (EAttribute)pLogicalFormulaEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getPLogicalFormula_Pattern() {
		return (EReference)pLogicalFormulaEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getPSubscription() {
		return pSubscriptionEClass;
	}
	 ...
	 */
	@Override
	public EReference getPSubscription_Patterns() {
		return (EReference)pSubscriptionEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		pLogicalFormulaEClass = createEClass(PLOGICAL_FORMULA);
		createEAttribute(pLogicalFormulaEClass, PLOGICAL_FORMULA__OPERATOR);
		createEReference(pLogicalFormulaEClass, PLOGICAL_FORMULA__PATTERN);
		...
		pSubscriptionEClass = createEClass(PSUBSCRIPTION);
		createEReference(pSubscriptionEClass, PSUBSCRIPTION__PATTERNS);
	...
	public void initializePackageContents() {
		...
		pLogicalFormulaEClass.getESuperTypes().add(this.getPPattern());
		...
		initEClass(pLogicalFormulaEClass, PLogicalFormula.class, "PLogicalFormula", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPLogicalFormula_Operator(), this.getPRestrictionsEnum(), "operator", null, 1, 1, PLogicalFormula.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPLogicalFormula_Pattern(), this.getPPattern(), null, "pattern", null, 1, -1, PLogicalFormula.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EOperation op = initEOperation(getPObject__GetSlot__EStructuralFeature(), this.getPSlot(), "getSlot", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(pSubscriptionEClass, PSubscription.class, "PSubscription", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPSubscription_Patterns(), this.getPPattern(), null, "patterns", null, 0, -1, PSubscription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getPPattern__Matches__Object(), ecorePackage.getEBoolean(), "matches", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEEnumLiteral(pRestrictionsEnumEEnum, PRestrictionsEnum.NOT);
