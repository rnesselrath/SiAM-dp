 ...
 * @generated
 */
public class PrimitiveTasksSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PrimitiveTasksPackage.PRIMITIVE_TASK: {
				PrimitiveTask primitiveTask = (PrimitiveTask)theEObject;
				T result = casePrimitiveTask(primitiveTask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PrimitiveTasksPackage.LIST_ITEM: {
