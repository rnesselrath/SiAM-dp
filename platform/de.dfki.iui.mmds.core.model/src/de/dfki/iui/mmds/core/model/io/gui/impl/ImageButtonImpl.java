 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.ImageButtonImpl#getResource <em>Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageButtonImpl extends ButtonImpl implements ImageButton {
	...
	protected EClass eStaticClass() {
		return GuiPackage.Literals.IMAGE_BUTTON;
	}
		...
		if (resource != null && resource.eIsProxy()) {
			...
			if (resource != oldResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GuiPackage.IMAGE_BUTTON__RESOURCE, oldResource, resource));
			}
		}
		return resource;
	}
	...
	public void setResource(Picture newResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.IMAGE_BUTTON__RESOURCE, oldResource, resource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GuiPackage.IMAGE_BUTTON__RESOURCE:
