 ...
 * @generated
 */
public class UpdatesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UpdatesPackage.UI_ELEMENT_UPDATE: {
			...
			case UpdatesPackage.TEXT_INPUT_UPDATE: {
			...
			case UpdatesPackage.LABEL_UPDATE: {
