 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.TangibleImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.TangibleImpl#getServiceInstance <em>Service Instance</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.TangibleImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.TangibleImpl#getBeginTime <em>Begin Time</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.TangibleImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.TangibleImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.TangibleImpl#getUserAlias <em>User Alias</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TangibleImpl extends BObjectImpl implements Tangible {
	/**
	...
	protected EClass eStaticClass() {
		return Io_interfacesPackage.Literals.TANGIBLE;
	}
	...
	public void setDevice(BString newDevice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.TANGIBLE__DEVICE, oldDevice, device));
	}
	...
	public void setServiceInstance(String newServiceInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.TANGIBLE__SERVICE_INSTANCE, oldServiceInstance, serviceInstance));
	}
	...
	public void setServiceName(String newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.TANGIBLE__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public void setBeginTime(Long newBeginTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.TANGIBLE__BEGIN_TIME, oldBeginTime, beginTime));
	}
	...
	public void setDuration(Long newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.TANGIBLE__DURATION, oldDuration, duration));
	}
	...
	public void setLanguage(BString newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.TANGIBLE__LANGUAGE, oldLanguage, language));
	}
	...
	public void setUserAlias(BString newUserAlias) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.TANGIBLE__USER_ALIAS, oldUserAlias, userAlias));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Io_interfacesPackage.TANGIBLE__DEVICE:
				return getDevice();
			case Io_interfacesPackage.TANGIBLE__SERVICE_INSTANCE:
				return getServiceInstance();
			case Io_interfacesPackage.TANGIBLE__SERVICE_NAME:
				return getServiceName();
			case Io_interfacesPackage.TANGIBLE__BEGIN_TIME:
				return getBeginTime();
			case Io_interfacesPackage.TANGIBLE__DURATION:
				return getDuration();
			case Io_interfacesPackage.TANGIBLE__LANGUAGE:
				return getLanguage();
			case Io_interfacesPackage.TANGIBLE__USER_ALIAS:
				return getUserAlias();
		}
