...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pulse Monitor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.PulseMonitorImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.PulseMonitorImpl#getServiceInstance <em>Service Instance</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.PulseMonitorImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.PulseMonitorImpl#getBeginTime <em>Begin Time</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.PulseMonitorImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.PulseMonitorImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.PulseMonitorImpl#getUserAlias <em>User Alias</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.PulseMonitorImpl#getPulse <em>Pulse</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PulseMonitorImpl extends BObjectImpl implements PulseMonitor {
	/**
	 ...
	 * @ordered
	 */
	protected static final BInteger PULSE_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected BInteger pulse = PULSE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return Io_interfacesPackage.Literals.PULSE_MONITOR;
	}
	...
	public void setDevice(BString newDevice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.PULSE_MONITOR__DEVICE, oldDevice, device));
	}
	...
	public void setServiceInstance(String newServiceInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.PULSE_MONITOR__SERVICE_INSTANCE, oldServiceInstance, serviceInstance));
	}
	...
	public void setServiceName(String newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.PULSE_MONITOR__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public void setBeginTime(Long newBeginTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.PULSE_MONITOR__BEGIN_TIME, oldBeginTime, beginTime));
	}
	...
	public void setDuration(Long newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.PULSE_MONITOR__DURATION, oldDuration, duration));
	}
	...
	public void setLanguage(BString newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.PULSE_MONITOR__LANGUAGE, oldLanguage, language));
	}
	...
	public void setUserAlias(BString newUserAlias) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.PULSE_MONITOR__USER_ALIAS, oldUserAlias, userAlias));
	}
	 ...
	 * @generated
	 */
	public void setPulse(BInteger newPulse) {
		BInteger oldPulse = pulse;
		pulse = newPulse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.PULSE_MONITOR__PULSE, oldPulse, pulse));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Io_interfacesPackage.PULSE_MONITOR__DEVICE:
				return getDevice();
			case Io_interfacesPackage.PULSE_MONITOR__SERVICE_INSTANCE:
				return getServiceInstance();
			case Io_interfacesPackage.PULSE_MONITOR__SERVICE_NAME:
				return getServiceName();
			case Io_interfacesPackage.PULSE_MONITOR__BEGIN_TIME:
				return getBeginTime();
			case Io_interfacesPackage.PULSE_MONITOR__DURATION:
				return getDuration();
			case Io_interfacesPackage.PULSE_MONITOR__LANGUAGE:
				return getLanguage();
			case Io_interfacesPackage.PULSE_MONITOR__USER_ALIAS:
				return getUserAlias();
			case Io_interfacesPackage.PULSE_MONITOR__PULSE:
				return getPulse();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Io_interfacesPackage.PULSE_MONITOR__PULSE:
				return PULSE_EDEFAULT == null ? pulse != null : !PULSE_EDEFAULT.equals(pulse);
		}
