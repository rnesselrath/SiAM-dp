 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.impl.PStringRestrictionImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.impl.PStringRestrictionImpl#isIgnoreCase <em>Ignore Case</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.impl.PStringRestrictionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.impl.PStringRestrictionImpl#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PStringRestrictionImpl extends MinimalEObjectImpl.Container implements PStringRestriction {
	...
	public boolean isSatisfiedBy(final Object value) {
		if (value instanceof String || value instanceof de.dfki.iui.mmds.core.emf.datatypes.BString) {
