...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Negative Auto Feedback</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.NegativeAutoFeedbackImpl#getSemanticContent <em>Semantic Content</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.NegativeAutoFeedbackImpl#isIsEllipsis <em>Is Ellipsis</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.NegativeAutoFeedbackImpl#getKnowledgeItem <em>Knowledge Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NegativeAutoFeedbackImpl extends BObjectImpl implements NegativeAutoFeedback {
	/**
	 ...
	 * @generated
	 */
	protected NegativeAutoFeedbackImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Communicative_functionsPackage.Literals.NEGATIVE_AUTO_FEEDBACK;
	}
	...
	public EList<SemanticContent> getSemanticContent() {
		if (semanticContent == null) {
			semanticContent = new EObjectContainmentEList<SemanticContent>(SemanticContent.class, this, Communicative_functionsPackage.NEGATIVE_AUTO_FEEDBACK__SEMANTIC_CONTENT);
		}
	...
	public void setIsEllipsis(boolean newIsEllipsis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.NEGATIVE_AUTO_FEEDBACK__IS_ELLIPSIS, oldIsEllipsis, isEllipsis));
	}
	...
	public void setKnowledgeItem(String newKnowledgeItem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.NEGATIVE_AUTO_FEEDBACK__KNOWLEDGE_ITEM, oldKnowledgeItem, knowledgeItem));
	}
