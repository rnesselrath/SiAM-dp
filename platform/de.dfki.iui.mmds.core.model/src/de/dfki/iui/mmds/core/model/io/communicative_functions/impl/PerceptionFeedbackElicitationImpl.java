...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Perception Feedback Elicitation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.PerceptionFeedbackElicitationImpl#getSemanticContent <em>Semantic Content</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.PerceptionFeedbackElicitationImpl#isIsEllipsis <em>Is Ellipsis</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.PerceptionFeedbackElicitationImpl#getKnowledgeItem <em>Knowledge Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PerceptionFeedbackElicitationImpl extends BObjectImpl implements PerceptionFeedbackElicitation {
	/**
	 ...
	 * @generated
	 */
	protected PerceptionFeedbackElicitationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Communicative_functionsPackage.Literals.PERCEPTION_FEEDBACK_ELICITATION;
	}
	...
	public EList<SemanticContent> getSemanticContent() {
		if (semanticContent == null) {
			semanticContent = new EObjectContainmentEList<SemanticContent>(SemanticContent.class, this, Communicative_functionsPackage.PERCEPTION_FEEDBACK_ELICITATION__SEMANTIC_CONTENT);
		}
	...
	public void setIsEllipsis(boolean newIsEllipsis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.PERCEPTION_FEEDBACK_ELICITATION__IS_ELLIPSIS, oldIsEllipsis, isEllipsis));
	}
	...
	public void setKnowledgeItem(String newKnowledgeItem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.PERCEPTION_FEEDBACK_ELICITATION__KNOWLEDGE_ITEM, oldKnowledgeItem, knowledgeItem));
	}
...
} //PerceptionFeedbackElicitationImpl
