...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>List Item Update</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.ListItemUpdateImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.ListItemUpdateImpl#getValue <em>Value</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.ListItemUpdateImpl#getSelected <em>Selected</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListItemUpdateImpl extends UIElementUpdateImpl implements ListItemUpdate {
	/**
	...
	protected EClass eStaticClass() {
		return GuiPackage.Literals.LIST_ITEM_UPDATE;
	}
	...
	public void setLabel(BString newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.LIST_ITEM_UPDATE__LABEL, oldLabel, label));
	}
	...
	public void setValue(BString newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.LIST_ITEM_UPDATE__VALUE, oldValue, value));
	}
	...
	public void setSelected(BBoolean newSelected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.LIST_ITEM_UPDATE__SELECTED, oldSelected, selected));
	}
