 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.dialogue.impl.ElseImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElseImpl extends MinimalEObjectImpl.Container implements Else {
	...
	protected EClass eStaticClass() {
		return DialoguePackage.Literals.ELSE;
	}
	...
	public EList<ExecutableContent> getContent() {
		if (content == null) {
			content = new EObjectContainmentEList<ExecutableContent>(ExecutableContent.class, this, DialoguePackage.ELSE__CONTENT);
		}
		return content;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DialoguePackage.ELSE__CONTENT:
