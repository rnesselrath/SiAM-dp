 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.impl.PObjectImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.impl.PObjectImpl#getSlot <em>Slot</em>}</li>
 * </ul>
 *
 * @generated
 */
						...
						if (tmpValue != null)
							if (isMany) {
								...
								if (feat.getName() == null) {
									Logger.getLogger(getClass()).warn(String.format("No feature type for one slot in %s defined.", ((PObject) slot.eContainer()).getType().getName()));
								} else {
