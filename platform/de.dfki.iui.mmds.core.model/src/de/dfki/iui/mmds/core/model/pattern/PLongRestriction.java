 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.pattern.PLongRestriction#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.mmds.core.model.pattern.PatternPackage#getPLongRestriction()
 * @model superTypes="de.dfki.iui.mmds.core.model.pattern.PNumberRestriction<de.dfki.iui.mmds.core.model.base.BLong>"
 * @generated
 */
public interface PLongRestriction extends PNumberRestriction<BLong> {
	 ...
	 * @see #setValue(BLong)
	 * @see de.dfki.iui.mmds.core.model.pattern.PatternPackage#getPLongRestriction_Value()
	 * @model dataType="de.dfki.iui.mmds.core.model.base.BLong"
	 * @generated
	 */
	BLong getValue();

	/**
	 * Sets the value of the '{@link de.dfki.iui.mmds.core.model.pattern.PLongRestriction#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
