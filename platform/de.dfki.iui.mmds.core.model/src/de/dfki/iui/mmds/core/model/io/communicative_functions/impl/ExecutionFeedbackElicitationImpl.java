...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Execution Feedback Elicitation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.ExecutionFeedbackElicitationImpl#getSemanticContent <em>Semantic Content</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.ExecutionFeedbackElicitationImpl#isIsEllipsis <em>Is Ellipsis</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.ExecutionFeedbackElicitationImpl#getKnowledgeItem <em>Knowledge Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExecutionFeedbackElicitationImpl extends BObjectImpl implements ExecutionFeedbackElicitation {
	/**
	 ...
	 * @generated
	 */
	protected ExecutionFeedbackElicitationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Communicative_functionsPackage.Literals.EXECUTION_FEEDBACK_ELICITATION;
	}
	...
	public EList<SemanticContent> getSemanticContent() {
		if (semanticContent == null) {
			semanticContent = new EObjectContainmentEList<SemanticContent>(SemanticContent.class, this, Communicative_functionsPackage.EXECUTION_FEEDBACK_ELICITATION__SEMANTIC_CONTENT);
		}
	...
	public void setIsEllipsis(boolean newIsEllipsis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.EXECUTION_FEEDBACK_ELICITATION__IS_ELLIPSIS, oldIsEllipsis, isEllipsis));
	}
	...
	public void setKnowledgeItem(String newKnowledgeItem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.EXECUTION_FEEDBACK_ELICITATION__KNOWLEDGE_ITEM, oldKnowledgeItem, knowledgeItem));
	}
...
} //ExecutionFeedbackElicitationImpl
