...
public class PatternSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PatternPackage.PLOGICAL_FORMULA: {
				PLogicalFormula pLogicalFormula = (PLogicalFormula)theEObject;
				T result = casePLogicalFormula(pLogicalFormula);
				if (result == null) result = casePPattern(pLogicalFormula);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PatternPackage.PSUBSCRIPTION: {
				PSubscription pSubscription = (PSubscription)theEObject;
				T result = casePSubscription(pSubscription);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>PLogical Formula</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>PLogical Formula</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePLogicalFormula(PLogicalFormula object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>PSubscription</em>'.
	 * <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>PSubscription</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePSubscription(PSubscription object) {
		return null;
	}
