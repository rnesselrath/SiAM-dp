...
/**
 */
package de.dfki.iui.mmds.core.model.json.util;
...
public class JsonAdapterFactory extends AdapterFactoryImpl {
	...
	protected JsonSwitch<Adapter> modelSwitch =
		new JsonSwitch<Adapter>() {
			@Override
			public Adapter caseJSONAbstractObject(JSONAbstractObject object) {
				return createJSONAbstractObjectAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseJSONAttribute(JSONAttribute object) {
				return createJSONAttributeAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseJSONParser(JSONParser object) {
				return createJSONParserAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.iui.mmds.core.model.json.JSONAbstractObject <em>JSON Abstract Object</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createJSONAbstractObjectAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.iui.mmds.core.model.json.JSONObject <em>JSON Object</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.iui.mmds.core.model.json.JSONAttribute <em>JSON Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createJSONAttributeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.iui.mmds.core.model.json.JSONValue <em>JSON Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.iui.mmds.core.model.json.JSONParser <em>JSON Parser</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createJSONParserAdapter() {
		return null;
	}
