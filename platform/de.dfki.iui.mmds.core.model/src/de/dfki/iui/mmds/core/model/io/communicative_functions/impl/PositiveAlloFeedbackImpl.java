...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Positive Allo Feedback</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.PositiveAlloFeedbackImpl#getSemanticContent <em>Semantic Content</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.PositiveAlloFeedbackImpl#isIsEllipsis <em>Is Ellipsis</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.PositiveAlloFeedbackImpl#getKnowledgeItem <em>Knowledge Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PositiveAlloFeedbackImpl extends BObjectImpl implements PositiveAlloFeedback {
	/**
	 ...
	 * @generated
	 */
	protected PositiveAlloFeedbackImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Communicative_functionsPackage.Literals.POSITIVE_ALLO_FEEDBACK;
	}
	...
	public EList<SemanticContent> getSemanticContent() {
		if (semanticContent == null) {
			semanticContent = new EObjectContainmentEList<SemanticContent>(SemanticContent.class, this, Communicative_functionsPackage.POSITIVE_ALLO_FEEDBACK__SEMANTIC_CONTENT);
		}
	...
	public void setIsEllipsis(boolean newIsEllipsis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.POSITIVE_ALLO_FEEDBACK__IS_ELLIPSIS, oldIsEllipsis, isEllipsis));
	}
	...
	public void setKnowledgeItem(String newKnowledgeItem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.POSITIVE_ALLO_FEEDBACK__KNOWLEDGE_ITEM, oldKnowledgeItem, knowledgeItem));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Communicative_functionsPackage.POSITIVE_ALLO_FEEDBACK__SEMANTIC_CONTENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Communicative_functionsPackage.POSITIVE_ALLO_FEEDBACK__IS_ELLIPSIS:
				return isIsEllipsis();
			case Communicative_functionsPackage.POSITIVE_ALLO_FEEDBACK__KNOWLEDGE_ITEM:
