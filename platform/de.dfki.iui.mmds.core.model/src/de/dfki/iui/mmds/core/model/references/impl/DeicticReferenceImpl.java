...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Deictic Reference</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.references.impl.DeicticReferenceImpl#getReferencePattern <em>Reference Pattern</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.references.impl.DeicticReferenceImpl#getHasMorphoSyntacticDecomposition <em>Has Morpho Syntactic Decomposition</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.references.impl.DeicticReferenceImpl#isIsMany <em>Is Many</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeicticReferenceImpl extends MinimalEObjectImpl.Container implements DeicticReference {
	/**
	 ...
	 * @generated
	 */
	protected DeicticReferenceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ReferencesPackage.Literals.DEICTIC_REFERENCE;
	}
	...
	public NotificationChain basicSetReferencePattern(PObject newReferencePattern, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReferencesPackage.DEICTIC_REFERENCE__REFERENCE_PATTERN, oldReferencePattern, newReferencePattern);
	...
	public void setReferencePattern(PObject newReferencePattern) {
		if (newReferencePattern != referencePattern) {
			...
			if (referencePattern != null)
				msgs = ((InternalEObject)referencePattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReferencesPackage.DEICTIC_REFERENCE__REFERENCE_PATTERN, null, msgs);
			if (newReferencePattern != null)
				msgs = ((InternalEObject)newReferencePattern).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReferencesPackage.DEICTIC_REFERENCE__REFERENCE_PATTERN, null, msgs);
			msgs = basicSetReferencePattern(newReferencePattern, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesPackage.DEICTIC_REFERENCE__REFERENCE_PATTERN, newReferencePattern, newReferencePattern));
	}
	...
	public NotificationChain basicSetHasMorphoSyntacticDecomposition(LingInfo newHasMorphoSyntacticDecomposition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReferencesPackage.DEICTIC_REFERENCE__HAS_MORPHO_SYNTACTIC_DECOMPOSITION, oldHasMorphoSyntacticDecomposition, newHasMorphoSyntacticDecomposition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHasMorphoSyntacticDecomposition(LingInfo newHasMorphoSyntacticDecomposition) {
		if (newHasMorphoSyntacticDecomposition != hasMorphoSyntacticDecomposition) {
			...
			if (hasMorphoSyntacticDecomposition != null)
				msgs = ((InternalEObject)hasMorphoSyntacticDecomposition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReferencesPackage.DEICTIC_REFERENCE__HAS_MORPHO_SYNTACTIC_DECOMPOSITION, null, msgs);
			if (newHasMorphoSyntacticDecomposition != null)
				msgs = ((InternalEObject)newHasMorphoSyntacticDecomposition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReferencesPackage.DEICTIC_REFERENCE__HAS_MORPHO_SYNTACTIC_DECOMPOSITION, null, msgs);
			msgs = basicSetHasMorphoSyntacticDecomposition(newHasMorphoSyntacticDecomposition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesPackage.DEICTIC_REFERENCE__HAS_MORPHO_SYNTACTIC_DECOMPOSITION, newHasMorphoSyntacticDecomposition, newHasMorphoSyntacticDecomposition));
	}
	...
	public void setIsMany(boolean newIsMany) {
		...
		isMany = newIsMany;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesPackage.DEICTIC_REFERENCE__IS_MANY, oldIsMany, isMany));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReferencesPackage.DEICTIC_REFERENCE__REFERENCE_PATTERN:
				return basicSetReferencePattern(null, msgs);
			case ReferencesPackage.DEICTIC_REFERENCE__HAS_MORPHO_SYNTACTIC_DECOMPOSITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ReferencesPackage.DEICTIC_REFERENCE__IS_MANY:
				return isIsMany();
		}
