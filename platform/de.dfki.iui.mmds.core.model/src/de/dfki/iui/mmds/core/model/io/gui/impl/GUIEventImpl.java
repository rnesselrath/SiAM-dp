 ...
 * <em><b>GUI Event</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.GUIEventImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.GUIEventImpl#getServiceInstance <em>Service Instance</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.GUIEventImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.GUIEventImpl#getBeginTime <em>Begin Time</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.GUIEventImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.GUIEventImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.GUIEventImpl#getUserAlias <em>User Alias</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.GUIEventImpl#getEventData <em>Event Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GUIEventImpl extends BObjectImpl implements GUIEvent {
	/**
	 ...
	 * @ordered
	 */
	protected GUIEventData eventData;
	...
	protected EClass eStaticClass() {
		return GuiPackage.Literals.GUI_EVENT;
	}
	...
	public void setDevice(BString newDevice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.GUI_EVENT__DEVICE, oldDevice, device));
	}
	...
	public void setServiceInstance(String newServiceInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.GUI_EVENT__SERVICE_INSTANCE, oldServiceInstance, serviceInstance));
	}
	...
	public void setServiceName(String newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.GUI_EVENT__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public void setBeginTime(Long newBeginTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.GUI_EVENT__BEGIN_TIME, oldBeginTime, beginTime));
	}
	...
	public void setDuration(Long newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.GUI_EVENT__DURATION, oldDuration, duration));
	}
	...
	public void setLanguage(BString newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.GUI_EVENT__LANGUAGE, oldLanguage, language));
	}
	...
	public void setUserAlias(BString newUserAlias) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.GUI_EVENT__USER_ALIAS, oldUserAlias, userAlias));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEventData(GUIEventData newEventData, NotificationChain msgs) {
		GUIEventData oldEventData = eventData;
		eventData = newEventData;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GuiPackage.GUI_EVENT__EVENT_DATA, oldEventData, newEventData);
	 ...
	 */
	@Override
	public void setEventData(GUIEventData newEventData) {
		if (newEventData != eventData) {
			NotificationChain msgs = null;
			if (eventData != null)
				msgs = ((InternalEObject)eventData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GuiPackage.GUI_EVENT__EVENT_DATA, null, msgs);
			if (newEventData != null)
				msgs = ((InternalEObject)newEventData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GuiPackage.GUI_EVENT__EVENT_DATA, null, msgs);
			msgs = basicSetEventData(newEventData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.GUI_EVENT__EVENT_DATA, newEventData, newEventData));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GuiPackage.GUI_EVENT__EVENT_DATA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GuiPackage.GUI_EVENT__DEVICE:
				return getDevice();
			case GuiPackage.GUI_EVENT__SERVICE_INSTANCE:
				return getServiceInstance();
			case GuiPackage.GUI_EVENT__SERVICE_NAME:
				return getServiceName();
			case GuiPackage.GUI_EVENT__BEGIN_TIME:
				return getBeginTime();
			case GuiPackage.GUI_EVENT__DURATION:
				return getDuration();
			case GuiPackage.GUI_EVENT__LANGUAGE:
				return getLanguage();
			case GuiPackage.GUI_EVENT__USER_ALIAS:
				return getUserAlias();
			case GuiPackage.GUI_EVENT__EVENT_DATA:
				return getEventData();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case GuiPackage.GUI_EVENT__USER_ALIAS:
				...
				return;
			case GuiPackage.GUI_EVENT__EVENT_DATA:
				setEventData((GUIEventData)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case GuiPackage.GUI_EVENT__USER_ALIAS:
				...
				return;
			case GuiPackage.GUI_EVENT__EVENT_DATA:
				setEventData((GUIEventData)null);
				return;
		}
