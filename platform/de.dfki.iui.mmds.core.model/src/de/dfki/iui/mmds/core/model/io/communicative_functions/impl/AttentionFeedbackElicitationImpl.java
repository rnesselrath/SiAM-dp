...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Attention Feedback Elicitation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.AttentionFeedbackElicitationImpl#getSemanticContent <em>Semantic Content</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.AttentionFeedbackElicitationImpl#isIsEllipsis <em>Is Ellipsis</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.AttentionFeedbackElicitationImpl#getKnowledgeItem <em>Knowledge Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttentionFeedbackElicitationImpl extends BObjectImpl implements AttentionFeedbackElicitation {
	/**
	 ...
	 * @generated
	 */
	protected AttentionFeedbackElicitationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Communicative_functionsPackage.Literals.ATTENTION_FEEDBACK_ELICITATION;
	}
	...
	public EList<SemanticContent> getSemanticContent() {
		if (semanticContent == null) {
			semanticContent = new EObjectContainmentEList<SemanticContent>(SemanticContent.class, this, Communicative_functionsPackage.ATTENTION_FEEDBACK_ELICITATION__SEMANTIC_CONTENT);
		}
	...
	public void setIsEllipsis(boolean newIsEllipsis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.ATTENTION_FEEDBACK_ELICITATION__IS_ELLIPSIS, oldIsEllipsis, isEllipsis));
	}
	...
	public void setKnowledgeItem(String newKnowledgeItem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.ATTENTION_FEEDBACK_ELICITATION__KNOWLEDGE_ITEM, oldKnowledgeItem, knowledgeItem));
	}
...
} //AttentionFeedbackElicitationImpl
