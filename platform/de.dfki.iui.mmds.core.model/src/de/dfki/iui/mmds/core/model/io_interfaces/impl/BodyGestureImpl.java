...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Body Gesture</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.BodyGestureImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.BodyGestureImpl#getServiceInstance <em>Service Instance</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.BodyGestureImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.BodyGestureImpl#getBeginTime <em>Begin Time</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.BodyGestureImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.BodyGestureImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io_interfaces.impl.BodyGestureImpl#getUserAlias <em>User Alias</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BodyGestureImpl extends BObjectImpl implements BodyGesture {
	/**
	...
	protected EClass eStaticClass() {
		return Io_interfacesPackage.Literals.BODY_GESTURE;
	}
	...
	public void setDevice(BString newDevice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.BODY_GESTURE__DEVICE, oldDevice, device));
	}
	...
	public void setServiceInstance(String newServiceInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.BODY_GESTURE__SERVICE_INSTANCE, oldServiceInstance, serviceInstance));
	}
	...
	public void setServiceName(String newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.BODY_GESTURE__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public void setBeginTime(Long newBeginTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.BODY_GESTURE__BEGIN_TIME, oldBeginTime, beginTime));
	}
	...
	public void setDuration(Long newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.BODY_GESTURE__DURATION, oldDuration, duration));
	}
	...
	public void setLanguage(BString newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.BODY_GESTURE__LANGUAGE, oldLanguage, language));
	}
	...
	public void setUserAlias(BString newUserAlias) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Io_interfacesPackage.BODY_GESTURE__USER_ALIAS, oldUserAlias, userAlias));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Io_interfacesPackage.BODY_GESTURE__DEVICE:
				return getDevice();
			case Io_interfacesPackage.BODY_GESTURE__SERVICE_INSTANCE:
				return getServiceInstance();
			case Io_interfacesPackage.BODY_GESTURE__SERVICE_NAME:
				return getServiceName();
			case Io_interfacesPackage.BODY_GESTURE__BEGIN_TIME:
				return getBeginTime();
			case Io_interfacesPackage.BODY_GESTURE__DURATION:
				return getDuration();
			case Io_interfacesPackage.BODY_GESTURE__LANGUAGE:
				return getLanguage();
			case Io_interfacesPackage.BODY_GESTURE__USER_ALIAS:
				return getUserAlias();
		}
