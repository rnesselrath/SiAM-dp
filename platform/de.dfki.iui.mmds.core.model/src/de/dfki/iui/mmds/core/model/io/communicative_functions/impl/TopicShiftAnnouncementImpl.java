...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Topic Shift Announcement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.TopicShiftAnnouncementImpl#getSemanticContent <em>Semantic Content</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.TopicShiftAnnouncementImpl#isIsEllipsis <em>Is Ellipsis</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.TopicShiftAnnouncementImpl#getKnowledgeItem <em>Knowledge Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TopicShiftAnnouncementImpl extends BObjectImpl implements TopicShiftAnnouncement {
	/**
	 ...
	 * @generated
	 */
	protected TopicShiftAnnouncementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Communicative_functionsPackage.Literals.TOPIC_SHIFT_ANNOUNCEMENT;
	}
	...
	public EList<SemanticContent> getSemanticContent() {
		if (semanticContent == null) {
			semanticContent = new EObjectContainmentEList<SemanticContent>(SemanticContent.class, this, Communicative_functionsPackage.TOPIC_SHIFT_ANNOUNCEMENT__SEMANTIC_CONTENT);
		}
	...
	public void setIsEllipsis(boolean newIsEllipsis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.TOPIC_SHIFT_ANNOUNCEMENT__IS_ELLIPSIS, oldIsEllipsis, isEllipsis));
	}
	...
	public void setKnowledgeItem(String newKnowledgeItem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.TOPIC_SHIFT_ANNOUNCEMENT__KNOWLEDGE_ITEM, oldKnowledgeItem, knowledgeItem));
	}
