 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.task.impl.TConditionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.task.impl.TConditionImpl#getPattern <em>Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TConditionImpl extends MinimalEObjectImpl.Container implements TCondition {
	...
	protected EClass eStaticClass() {
		return TaskPackage.Literals.TCONDITION;
	}
	...
	public void setExpr(String newExpr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.TCONDITION__EXPR, oldExpr, expr));
	}
	...
	public EList<PPattern> getPattern() {
		if (pattern == null) {
			pattern = new EObjectContainmentEList<PPattern>(PPattern.class, this, TaskPackage.TCONDITION__PATTERN);
		}
		return pattern;
	}
