...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Check Box Update</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.CheckBoxUpdateImpl#getChecked <em>Checked</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.gui.impl.CheckBoxUpdateImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CheckBoxUpdateImpl extends UIElementUpdateImpl implements CheckBoxUpdate {
	/**
	...
	protected EClass eStaticClass() {
		return GuiPackage.Literals.CHECK_BOX_UPDATE;
	}
	...
	public void setChecked(BBoolean newChecked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.CHECK_BOX_UPDATE__CHECKED, oldChecked, checked));
	}
	...
	public void setValue(BString newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuiPackage.CHECK_BOX_UPDATE__VALUE, oldValue, value));
	}
