 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.RequestImpl#getSemanticContent <em>Semantic Content</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.RequestImpl#isIsEllipsis <em>Is Ellipsis</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.RequestImpl#getKnowledgeItem <em>Knowledge Item</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.RequestImpl#getRequestInfo <em>Request Info</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequestImpl extends BObjectImpl implements Request {
	/**
	...
	/**
	 * The default value of the '{@link #getRequestInfo() <em>Request Info</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRequestInfo()
	 * @generated
	 * @ordered
	 */
	protected static final BString REQUEST_INFO_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getRequestInfo() <em>Request Info</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRequestInfo()
	 * @generated
	 * @ordered
	 */
	protected BString requestInfo = REQUEST_INFO_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return Communicative_functionsPackage.Literals.REQUEST;
	}
	...
	public EList<SemanticContent> getSemanticContent() {
		if (semanticContent == null) {
			semanticContent = new EObjectContainmentEList<SemanticContent>(SemanticContent.class, this, Communicative_functionsPackage.REQUEST__SEMANTIC_CONTENT);
		}
	...
	public void setIsEllipsis(boolean newIsEllipsis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.REQUEST__IS_ELLIPSIS, oldIsEllipsis, isEllipsis));
	}
	...
	public void setKnowledgeItem(String newKnowledgeItem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.REQUEST__KNOWLEDGE_ITEM, oldKnowledgeItem, knowledgeItem));
	}
	 ...
	 * @generated
	 */
	public void setRequestInfo(BString newRequestInfo) {
		BString oldRequestInfo = requestInfo;
		requestInfo = newRequestInfo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.REQUEST__REQUEST_INFO, oldRequestInfo, requestInfo));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Communicative_functionsPackage.REQUEST__SEMANTIC_CONTENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Communicative_functionsPackage.REQUEST__IS_ELLIPSIS:
				return isIsEllipsis();
			case Communicative_functionsPackage.REQUEST__KNOWLEDGE_ITEM:
				return getKnowledgeItem();
			case Communicative_functionsPackage.REQUEST__REQUEST_INFO:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Communicative_functionsPackage.REQUEST__KNOWLEDGE_ITEM:
				...
				return;
			case Communicative_functionsPackage.REQUEST__REQUEST_INFO:
				setRequestInfo((BString)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case Communicative_functionsPackage.REQUEST__KNOWLEDGE_ITEM:
				...
				return;
			case Communicative_functionsPackage.REQUEST__REQUEST_INFO:
				setRequestInfo(REQUEST_INFO_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Communicative_functionsPackage.REQUEST__REQUEST_INFO:
				return REQUEST_INFO_EDEFAULT == null ? requestInfo != null : !REQUEST_INFO_EDEFAULT.equals(requestInfo);
		}
