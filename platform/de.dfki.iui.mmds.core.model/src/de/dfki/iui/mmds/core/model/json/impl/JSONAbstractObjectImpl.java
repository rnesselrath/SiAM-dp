...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>JSON Abstract Object</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.json.impl.JSONAbstractObjectImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.json.impl.JSONAbstractObjectImpl#getServiceInstance <em>Service Instance</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.json.impl.JSONAbstractObjectImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.json.impl.JSONAbstractObjectImpl#getBeginTime <em>Begin Time</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.json.impl.JSONAbstractObjectImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.json.impl.JSONAbstractObjectImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.json.impl.JSONAbstractObjectImpl#getUserAlias <em>User Alias</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class JSONAbstractObjectImpl extends BObjectImpl implements JSONAbstractObject {
	/**
	 ...
	 * @generated
	 */
	protected JSONAbstractObjectImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return JsonPackage.Literals.JSON_ABSTRACT_OBJECT;
	}
	...
	public void setDevice(BString newDevice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonPackage.JSON_ABSTRACT_OBJECT__DEVICE, oldDevice, device));
	}
	...
	public void setServiceInstance(String newServiceInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonPackage.JSON_ABSTRACT_OBJECT__SERVICE_INSTANCE, oldServiceInstance, serviceInstance));
	}
	...
	public void setServiceName(String newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonPackage.JSON_ABSTRACT_OBJECT__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public void setBeginTime(Long newBeginTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonPackage.JSON_ABSTRACT_OBJECT__BEGIN_TIME, oldBeginTime, beginTime));
	}
	...
	public void setDuration(Long newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonPackage.JSON_ABSTRACT_OBJECT__DURATION, oldDuration, duration));
	}
	...
	public void setLanguage(BString newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonPackage.JSON_ABSTRACT_OBJECT__LANGUAGE, oldLanguage, language));
	}
	...
	public void setUserAlias(BString newUserAlias) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonPackage.JSON_ABSTRACT_OBJECT__USER_ALIAS, oldUserAlias, userAlias));
	}
