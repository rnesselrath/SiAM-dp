...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Apology Downplay</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.ApologyDownplayImpl#getSemanticContent <em>Semantic Content</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.ApologyDownplayImpl#isIsEllipsis <em>Is Ellipsis</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.core.model.io.communicative_functions.impl.ApologyDownplayImpl#getKnowledgeItem <em>Knowledge Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApologyDownplayImpl extends BObjectImpl implements ApologyDownplay {
	/**
	...
	protected EClass eStaticClass() {
		return Communicative_functionsPackage.Literals.APOLOGY_DOWNPLAY;
	}
	...
	public EList<SemanticContent> getSemanticContent() {
		if (semanticContent == null) {
			semanticContent = new EObjectContainmentEList<SemanticContent>(SemanticContent.class, this, Communicative_functionsPackage.APOLOGY_DOWNPLAY__SEMANTIC_CONTENT);
		}
	...
	public void setIsEllipsis(boolean newIsEllipsis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.APOLOGY_DOWNPLAY__IS_ELLIPSIS, oldIsEllipsis, isEllipsis));
	}
	...
	public void setKnowledgeItem(String newKnowledgeItem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Communicative_functionsPackage.APOLOGY_DOWNPLAY__KNOWLEDGE_ITEM, oldKnowledgeItem, knowledgeItem));
	}
