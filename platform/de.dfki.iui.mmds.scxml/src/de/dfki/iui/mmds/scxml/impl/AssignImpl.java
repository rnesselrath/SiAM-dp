 ...
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.scxml.impl.AssignImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.scxml.impl.AssignImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link de.dfki.iui.mmds.scxml.impl.AssignImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssignImpl extends EObjectImpl implements Assign {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScxmlPackage.ASSIGN__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ScxmlPackage.ASSIGN__EXPR:
				return getExpr();
			case ScxmlPackage.ASSIGN__NAME:
				return getName();
		}
