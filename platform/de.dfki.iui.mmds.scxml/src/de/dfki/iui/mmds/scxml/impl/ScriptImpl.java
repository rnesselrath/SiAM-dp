 ...
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.scxml.impl.ScriptImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScriptImpl extends EObjectImpl implements Script {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScxmlPackage.SCRIPT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ScxmlPackage.SCRIPT__VALUE:
				return getValue();
		}
