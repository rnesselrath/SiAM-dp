 ...
 * <ul>
 *   <li>{@link de.dfki.iui.mmds.scxml.impl.ContentImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContentImpl extends EObjectImpl implements Content {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScxmlPackage.CONTENT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ScxmlPackage.CONTENT__VALUE:
				return getValue();
		}
